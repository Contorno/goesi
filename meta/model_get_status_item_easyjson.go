...
func easyjson3c44e3bdDecodeGithubComContornoGoesiMeta(in *jlexer.Lexer, out *GetStatusItemList) {
...
func easyjson3c44e3bdEncodeGithubComContornoGoesiMeta(out *jwriter.Writer, in GetStatusItemList) {
...
func (v GetStatusItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c44e3bdEncodeGithubComContornoGoesiMeta(&w, v)
...
func (v *GetStatusItemList) UnmarshalJSON(data []byte) error {
	...
	easyjson3c44e3bdDecodeGithubComContornoGoesiMeta(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetStatusItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c44e3bdDecodeGithubComContornoGoesiMeta(l, v)
}
func easyjson3c44e3bdDecodeGithubComContornoGoesiMeta1(in *jlexer.Lexer, out *GetStatusItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c44e3bdEncodeGithubComContornoGoesiMeta1(out *jwriter.Writer, in GetStatusItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Endpoint != "" {
...
func (v GetStatusItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c44e3bdEncodeGithubComContornoGoesiMeta1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetStatusItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3c44e3bdDecodeGithubComContornoGoesiMeta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetStatusItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c44e3bdDecodeGithubComContornoGoesiMeta1(l, v)
}
