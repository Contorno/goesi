...
func easyjson8356b13dDecodeGithubComContornoGoesiMeta(in *jlexer.Lexer, out *GetVerifyOkList) {
...
func easyjson8356b13dEncodeGithubComContornoGoesiMeta(out *jwriter.Writer, in GetVerifyOkList) {
...
func (v GetVerifyOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8356b13dEncodeGithubComContornoGoesiMeta(&w, v)
...
func (v *GetVerifyOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8356b13dDecodeGithubComContornoGoesiMeta(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetVerifyOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8356b13dDecodeGithubComContornoGoesiMeta(l, v)
}
func easyjson8356b13dDecodeGithubComContornoGoesiMeta1(in *jlexer.Lexer, out *GetVerifyOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8356b13dEncodeGithubComContornoGoesiMeta1(out *jwriter.Writer, in GetVerifyOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterID != 0 {
...
func (v GetVerifyOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8356b13dEncodeGithubComContornoGoesiMeta1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetVerifyOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8356b13dDecodeGithubComContornoGoesiMeta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetVerifyOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8356b13dDecodeGithubComContornoGoesiMeta1(l, v)
}
