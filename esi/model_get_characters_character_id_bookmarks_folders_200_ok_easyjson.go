...
func easyjson47f8f3adDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksFolders200OkList) {
...
func easyjson47f8f3adEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksFolders200OkList) {
...
func (v GetCharactersCharacterIdBookmarksFolders200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson47f8f3adEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdBookmarksFolders200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson47f8f3adDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksFolders200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson47f8f3adDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson47f8f3adDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksFolders200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson47f8f3adEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksFolders200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FolderId != 0 {
...
func (v GetCharactersCharacterIdBookmarksFolders200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson47f8f3adEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdBookmarksFolders200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson47f8f3adDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksFolders200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson47f8f3adDecodeGithubComContornoGoesiEsi1(l, v)
}
