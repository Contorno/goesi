...
func easyjson37f7d2d4DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesHomeLocationList) {
...
func easyjson37f7d2d4EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdClonesHomeLocationList) {
...
func (v GetCharactersCharacterIdClonesHomeLocationList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson37f7d2d4EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdClonesHomeLocationList) UnmarshalJSON(data []byte) error {
	...
	easyjson37f7d2d4DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesHomeLocationList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson37f7d2d4DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson37f7d2d4DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesHomeLocation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson37f7d2d4EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdClonesHomeLocation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LocationId != 0 {
...
func (v GetCharactersCharacterIdClonesHomeLocation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson37f7d2d4EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdClonesHomeLocation) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson37f7d2d4DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesHomeLocation) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson37f7d2d4DecodeGithubComContornoGoesiEsi1(l, v)
}
