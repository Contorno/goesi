...
func easyjsonFbe2469DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdAttendees200OkList) {
...
func easyjsonFbe2469EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdAttendees200OkList) {
...
func (v GetCharactersCharacterIdCalendarEventIdAttendees200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFbe2469EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdCalendarEventIdAttendees200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFbe2469DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdAttendees200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFbe2469DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFbe2469DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdAttendees200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFbe2469EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdAttendees200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetCharactersCharacterIdCalendarEventIdAttendees200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFbe2469EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdCalendarEventIdAttendees200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFbe2469DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdAttendees200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFbe2469DecodeGithubComContornoGoesiEsi1(l, v)
}
