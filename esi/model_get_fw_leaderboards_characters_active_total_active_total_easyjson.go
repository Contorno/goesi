...
func easyjson85507fe2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotalActiveTotalList) {
...
func easyjson85507fe2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotalActiveTotalList) {
...
func (v GetFwLeaderboardsCharactersActiveTotalActiveTotalList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson85507fe2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotalList) UnmarshalJSON(data []byte) error {
	...
	easyjson85507fe2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotalList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson85507fe2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson85507fe2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotalActiveTotal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85507fe2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotalActiveTotal) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersActiveTotalActiveTotal) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson85507fe2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson85507fe2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson85507fe2DecodeGithubComContornoGoesiEsi1(l, v)
}
