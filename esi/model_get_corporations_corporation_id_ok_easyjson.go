...
func easyjson71be149aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdOkList) {
...
func easyjson71be149aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdOkList) {
...
func (v GetCorporationsCorporationIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71be149aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson71be149aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71be149aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson71be149aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson71be149aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetCorporationsCorporationIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71be149aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson71be149aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71be149aDecodeGithubComContornoGoesiEsi1(l, v)
}
