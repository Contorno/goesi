...
func easyjsonEf608ee4DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdOrdersHistory200OkList) {
...
func easyjsonEf608ee4EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdOrdersHistory200OkList) {
...
func (v GetCorporationsCorporationIdOrdersHistory200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEf608ee4EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdOrdersHistory200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEf608ee4DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOrdersHistory200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEf608ee4DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonEf608ee4DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdOrdersHistory200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEf608ee4EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdOrdersHistory200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Duration != 0 {
...
func (v GetCorporationsCorporationIdOrdersHistory200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEf608ee4EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdOrdersHistory200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEf608ee4DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOrdersHistory200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEf608ee4DecodeGithubComContornoGoesiEsi1(l, v)
}
