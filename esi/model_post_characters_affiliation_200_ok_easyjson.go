...
func easyjson2003668DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCharactersAffiliation200OkList) {
...
func easyjson2003668EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCharactersAffiliation200OkList) {
...
func (v PostCharactersAffiliation200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2003668EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCharactersAffiliation200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson2003668DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersAffiliation200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2003668DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson2003668DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCharactersAffiliation200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2003668EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCharactersAffiliation200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v PostCharactersAffiliation200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2003668EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersAffiliation200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2003668DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersAffiliation200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2003668DecodeGithubComContornoGoesiEsi1(l, v)
}
