...
func easyjson71b62f52DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStationsStationIdOkList) {
...
func easyjson71b62f52EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStationsStationIdOkList) {
...
func (v GetUniverseStationsStationIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71b62f52EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStationsStationIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson71b62f52DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71b62f52DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson71b62f52DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStationsStationIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson71b62f52EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStationsStationIdOk) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetUniverseStationsStationIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71b62f52EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStationsStationIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson71b62f52DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71b62f52DecodeGithubComContornoGoesiEsi1(l, v)
}
