...
func easyjsonD3bf458fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdTitles200OkList) {
...
func easyjsonD3bf458fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdTitles200OkList) {
...
func (v GetCharactersCharacterIdTitles200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD3bf458fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdTitles200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonD3bf458fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdTitles200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD3bf458fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonD3bf458fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdTitles200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD3bf458fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdTitles200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func (v GetCharactersCharacterIdTitles200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD3bf458fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdTitles200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD3bf458fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdTitles200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD3bf458fDecodeGithubComContornoGoesiEsi1(l, v)
}
