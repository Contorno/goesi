...
func easyjson5c3e6de0DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdMedalsIssued200OkList) {
...
func easyjson5c3e6de0EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdMedalsIssued200OkList) {
...
func (v GetCorporationsCorporationIdMedalsIssued200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5c3e6de0EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdMedalsIssued200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5c3e6de0DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMedalsIssued200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5c3e6de0DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5c3e6de0DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdMedalsIssued200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5c3e6de0EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdMedalsIssued200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetCorporationsCorporationIdMedalsIssued200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5c3e6de0EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdMedalsIssued200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5c3e6de0DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMedalsIssued200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5c3e6de0DecodeGithubComContornoGoesiEsi1(l, v)
}
