...
func easyjsonAb366fb4DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCharactersCharacterIdAssetsLocationsPositionList) {
...
func easyjsonAb366fb4EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCharactersCharacterIdAssetsLocationsPositionList) {
...
func (v PostCharactersCharacterIdAssetsLocationsPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAb366fb4EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCharactersCharacterIdAssetsLocationsPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjsonAb366fb4DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdAssetsLocationsPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAb366fb4DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonAb366fb4DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCharactersCharacterIdAssetsLocationsPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAb366fb4EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCharactersCharacterIdAssetsLocationsPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v PostCharactersCharacterIdAssetsLocationsPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAb366fb4EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdAssetsLocationsPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonAb366fb4DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdAssetsLocationsPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAb366fb4DecodeGithubComContornoGoesiEsi1(l, v)
}
