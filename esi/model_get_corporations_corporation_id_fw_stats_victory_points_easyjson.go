...
func easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdFwStatsVictoryPointsList) {
...
func easyjsonB4a61b3aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdFwStatsVictoryPointsList) {
...
func (v GetCorporationsCorporationIdFwStatsVictoryPointsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB4a61b3aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdFwStatsVictoryPointsList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFwStatsVictoryPointsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdFwStatsVictoryPoints) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB4a61b3aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdFwStatsVictoryPoints) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastWeek != 0 {
...
func (v GetCorporationsCorporationIdFwStatsVictoryPoints) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB4a61b3aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdFwStatsVictoryPoints) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFwStatsVictoryPoints) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB4a61b3aDecodeGithubComContornoGoesiEsi1(l, v)
}
