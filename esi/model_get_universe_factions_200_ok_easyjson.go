...
func easyjsonDac4178DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseFactions200OkList) {
...
func easyjsonDac4178EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseFactions200OkList) {
...
func (v GetUniverseFactions200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDac4178EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseFactions200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonDac4178DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseFactions200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDac4178DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonDac4178DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseFactions200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDac4178EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseFactions200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetUniverseFactions200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDac4178EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseFactions200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDac4178DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseFactions200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDac4178DecodeGithubComContornoGoesiEsi1(l, v)
}
