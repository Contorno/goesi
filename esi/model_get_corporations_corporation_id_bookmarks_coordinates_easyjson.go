...
func easyjsonEbd51f9DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksCoordinatesList) {
...
func easyjsonEbd51f9EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksCoordinatesList) {
...
func (v GetCorporationsCorporationIdBookmarksCoordinatesList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEbd51f9EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdBookmarksCoordinatesList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEbd51f9DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksCoordinatesList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEbd51f9DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonEbd51f9DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksCoordinates) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEbd51f9EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksCoordinates) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetCorporationsCorporationIdBookmarksCoordinates) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEbd51f9EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdBookmarksCoordinates) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEbd51f9DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksCoordinates) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEbd51f9DecodeGithubComContornoGoesiEsi1(l, v)
}
