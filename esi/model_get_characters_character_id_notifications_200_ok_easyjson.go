...
func easyjson697854beDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdNotifications200OkList) {
...
func easyjson697854beEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdNotifications200OkList) {
...
func (v GetCharactersCharacterIdNotifications200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson697854beEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdNotifications200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson697854beDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdNotifications200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson697854beDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson697854beDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdNotifications200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson697854beEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdNotifications200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IsRead {
...
func (v GetCharactersCharacterIdNotifications200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson697854beEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdNotifications200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson697854beDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdNotifications200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson697854beDecodeGithubComContornoGoesiEsi1(l, v)
}
