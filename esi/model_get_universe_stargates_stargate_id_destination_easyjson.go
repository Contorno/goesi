...
func easyjson5e6bca6DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdDestinationList) {
...
func easyjson5e6bca6EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStargatesStargateIdDestinationList) {
...
func (v GetUniverseStargatesStargateIdDestinationList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5e6bca6EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStargatesStargateIdDestinationList) UnmarshalJSON(data []byte) error {
	...
	easyjson5e6bca6DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdDestinationList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5e6bca6DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5e6bca6DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdDestination) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5e6bca6EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStargatesStargateIdDestination) {
	out.RawByte('{')
	first := true
	_ = first
	if in.StargateId != 0 {
...
func (v GetUniverseStargatesStargateIdDestination) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5e6bca6EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStargatesStargateIdDestination) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5e6bca6DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdDestination) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5e6bca6DecodeGithubComContornoGoesiEsi1(l, v)
}
