...
func easyjsonF3c409e3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostFleetsFleetIdWingsCreatedList) {
...
func easyjsonF3c409e3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostFleetsFleetIdWingsCreatedList) {
...
func (v PostFleetsFleetIdWingsCreatedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF3c409e3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostFleetsFleetIdWingsCreatedList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF3c409e3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsCreatedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF3c409e3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonF3c409e3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostFleetsFleetIdWingsCreated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF3c409e3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostFleetsFleetIdWingsCreated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.WingId != 0 {
...
func (v PostFleetsFleetIdWingsCreated) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF3c409e3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostFleetsFleetIdWingsCreated) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF3c409e3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsCreated) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF3c409e3DecodeGithubComContornoGoesiEsi1(l, v)
}
