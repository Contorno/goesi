...
func easyjson7c5b8388DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsRegionIdHistory200OkList) {
...
func easyjson7c5b8388EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsRegionIdHistory200OkList) {
...
func (v GetMarketsRegionIdHistory200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c5b8388EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsRegionIdHistory200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson7c5b8388DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistory200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c5b8388DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson7c5b8388DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsRegionIdHistory200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c5b8388EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsRegionIdHistory200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Average != 0 {
...
func (v GetMarketsRegionIdHistory200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c5b8388EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsRegionIdHistory200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c5b8388DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistory200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c5b8388DecodeGithubComContornoGoesiEsi1(l, v)
}
