...
func easyjsonF4e2485aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdOkList) {
...
func easyjsonF4e2485aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseSystemsSystemIdOkList) {
...
func (v GetUniverseSystemsSystemIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF4e2485aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseSystemsSystemIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF4e2485aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF4e2485aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonF4e2485aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "planets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonF4e2485aDecodeGithubComContornoGoesiEsi2(in, &v4)
		...
		case "position":
			easyjsonF4e2485aDecodeGithubComContornoGoesiEsi3(in, &out.Position)
		case "security_class":
...
func easyjsonF4e2485aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseSystemsSystemIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.Planets) != 0 {
		...
		}
		{
			...
			for v7, v8 := range in.Planets {
				...
				easyjsonF4e2485aEncodeGithubComContornoGoesiEsi2(out, v8)
			}
			out.RawByte(']')
		}
	}
	if true {
		...
		easyjsonF4e2485aEncodeGithubComContornoGoesiEsi3(out, in.Position)
	}
	if in.SecurityClass != "" {
...
func (v GetUniverseSystemsSystemIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF4e2485aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSystemsSystemIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF4e2485aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF4e2485aDecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjsonF4e2485aDecodeGithubComContornoGoesiEsi3(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF4e2485aEncodeGithubComContornoGoesiEsi3(out *jwriter.Writer, in GetUniverseSystemsSystemIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func easyjsonF4e2485aDecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPlanet) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF4e2485aEncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetUniverseSystemsSystemIdPlanet) {
	out.RawByte('{')
	first := true
	_ = first
