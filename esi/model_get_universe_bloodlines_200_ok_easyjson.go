...
func easyjson9e281deaDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseBloodlines200OkList) {
...
func easyjson9e281deaEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseBloodlines200OkList) {
...
func (v GetUniverseBloodlines200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9e281deaEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseBloodlines200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson9e281deaDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseBloodlines200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9e281deaDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9e281deaDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseBloodlines200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9e281deaEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseBloodlines200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.BloodlineId != 0 {
...
func (v GetUniverseBloodlines200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9e281deaEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseBloodlines200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9e281deaDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseBloodlines200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9e281deaDecodeGithubComContornoGoesiEsi1(l, v)
}
