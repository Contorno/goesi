...
func easyjson5567d6bcDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseAncestries200OkList) {
...
func easyjson5567d6bcEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseAncestries200OkList) {
...
func (v GetUniverseAncestries200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5567d6bcEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseAncestries200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5567d6bcDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAncestries200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5567d6bcDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5567d6bcDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseAncestries200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5567d6bcEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseAncestries200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.BloodlineId != 0 {
...
func (v GetUniverseAncestries200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5567d6bcEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseAncestries200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5567d6bcDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAncestries200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5567d6bcDecodeGithubComContornoGoesiEsi1(l, v)
}
