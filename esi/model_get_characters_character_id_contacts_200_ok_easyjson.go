...
func easyjsonCb381401DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdContacts200OkList) {
...
func easyjsonCb381401EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdContacts200OkList) {
...
func (v GetCharactersCharacterIdContacts200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCb381401EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdContacts200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCb381401DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContacts200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCb381401DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCb381401DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdContacts200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCb381401EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdContacts200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ContactId != 0 {
...
func (v GetCharactersCharacterIdContacts200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCb381401EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdContacts200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCb381401DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContacts200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCb381401DecodeGithubComContornoGoesiEsi1(l, v)
}
