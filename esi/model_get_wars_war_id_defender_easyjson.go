...
func easyjson79787df1DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetWarsWarIdDefenderList) {
...
func easyjson79787df1EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetWarsWarIdDefenderList) {
...
func (v GetWarsWarIdDefenderList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson79787df1EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetWarsWarIdDefenderList) UnmarshalJSON(data []byte) error {
	...
	easyjson79787df1DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdDefenderList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson79787df1DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson79787df1DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdDefender) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson79787df1EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdDefender) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetWarsWarIdDefender) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson79787df1EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetWarsWarIdDefender) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson79787df1DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdDefender) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson79787df1DecodeGithubComContornoGoesiEsi1(l, v)
}
