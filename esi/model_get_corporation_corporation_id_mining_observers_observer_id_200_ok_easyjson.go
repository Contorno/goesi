...
func easyjson77cbcc92DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationCorporationIdMiningObserversObserverId200OkList) {
...
func easyjson77cbcc92EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationCorporationIdMiningObserversObserverId200OkList) {
...
func (v GetCorporationCorporationIdMiningObserversObserverId200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson77cbcc92EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationCorporationIdMiningObserversObserverId200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson77cbcc92DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationCorporationIdMiningObserversObserverId200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson77cbcc92DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson77cbcc92DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationCorporationIdMiningObserversObserverId200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson77cbcc92EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationCorporationIdMiningObserversObserverId200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetCorporationCorporationIdMiningObserversObserverId200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson77cbcc92EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationCorporationIdMiningObserversObserverId200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson77cbcc92DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationCorporationIdMiningObserversObserverId200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson77cbcc92DecodeGithubComContornoGoesiEsi1(l, v)
}
