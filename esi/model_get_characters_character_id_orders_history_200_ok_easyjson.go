...
func easyjsonCe7c86daDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdOrdersHistory200OkList) {
...
func easyjsonCe7c86daEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdOrdersHistory200OkList) {
...
func (v GetCharactersCharacterIdOrdersHistory200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCe7c86daEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdOrdersHistory200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCe7c86daDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdOrdersHistory200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCe7c86daDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCe7c86daDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdOrdersHistory200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCe7c86daEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdOrdersHistory200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Duration != 0 {
...
func (v GetCharactersCharacterIdOrdersHistory200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCe7c86daEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdOrdersHistory200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCe7c86daDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdOrdersHistory200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCe7c86daDecodeGithubComContornoGoesiEsi1(l, v)
}
