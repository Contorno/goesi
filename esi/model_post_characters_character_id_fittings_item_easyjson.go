...
func easyjsonFea181e2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsItemList) {
...
func easyjsonFea181e2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCharactersCharacterIdFittingsItemList) {
...
func (v PostCharactersCharacterIdFittingsItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFea181e2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCharactersCharacterIdFittingsItemList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFea181e2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFea181e2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFea181e2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFea181e2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCharactersCharacterIdFittingsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != "" {
...
func (v PostCharactersCharacterIdFittingsItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFea181e2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdFittingsItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFea181e2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFea181e2DecodeGithubComContornoGoesiEsi1(l, v)
}
