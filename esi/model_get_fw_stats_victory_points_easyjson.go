...
func easyjson52c21dd9DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwStatsVictoryPointsList) {
...
func easyjson52c21dd9EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwStatsVictoryPointsList) {
...
func (v GetFwStatsVictoryPointsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson52c21dd9EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwStatsVictoryPointsList) UnmarshalJSON(data []byte) error {
	...
	easyjson52c21dd9DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwStatsVictoryPointsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson52c21dd9DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson52c21dd9DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwStatsVictoryPoints) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson52c21dd9EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwStatsVictoryPoints) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastWeek != 0 {
...
func (v GetFwStatsVictoryPoints) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson52c21dd9EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwStatsVictoryPoints) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson52c21dd9DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwStatsVictoryPoints) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson52c21dd9DecodeGithubComContornoGoesiEsi1(l, v)
}
