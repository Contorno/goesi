...
func easyjson9d3eb98fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetSovereigntyMap200OkList) {
...
func easyjson9d3eb98fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetSovereigntyMap200OkList) {
...
func (v GetSovereigntyMap200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9d3eb98fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetSovereigntyMap200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson9d3eb98fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyMap200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9d3eb98fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9d3eb98fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetSovereigntyMap200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9d3eb98fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetSovereigntyMap200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetSovereigntyMap200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9d3eb98fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetSovereigntyMap200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9d3eb98fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyMap200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9d3eb98fDecodeGithubComContornoGoesiEsi1(l, v)
}
