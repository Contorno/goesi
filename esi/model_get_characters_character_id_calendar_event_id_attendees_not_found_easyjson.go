...
func easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdAttendeesNotFoundList) {
...
func easyjsonB3bdffdaEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdAttendeesNotFoundList) {
...
func (v GetCharactersCharacterIdCalendarEventIdAttendeesNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB3bdffdaEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdCalendarEventIdAttendeesNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdAttendeesNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdAttendeesNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB3bdffdaEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdAttendeesNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCharactersCharacterIdCalendarEventIdAttendeesNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB3bdffdaEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdCalendarEventIdAttendeesNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdAttendeesNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB3bdffdaDecodeGithubComContornoGoesiEsi1(l, v)
}
