...
func easyjson9c6d54f9DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdStarbasesStarbaseIdFuelList) {
...
func easyjson9c6d54f9EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdStarbasesStarbaseIdFuelList) {
...
func (v GetCorporationsCorporationIdStarbasesStarbaseIdFuelList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9c6d54f9EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdStarbasesStarbaseIdFuelList) UnmarshalJSON(data []byte) error {
	...
	easyjson9c6d54f9DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStarbasesStarbaseIdFuelList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9c6d54f9DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9c6d54f9DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdStarbasesStarbaseIdFuel) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9c6d54f9EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdStarbasesStarbaseIdFuel) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Quantity != 0 {
...
func (v GetCorporationsCorporationIdStarbasesStarbaseIdFuel) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9c6d54f9EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdStarbasesStarbaseIdFuel) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9c6d54f9DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStarbasesStarbaseIdFuel) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9c6d54f9DecodeGithubComContornoGoesiEsi1(l, v)
}
