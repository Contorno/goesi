...
func easyjsonB48e5cffDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationCorporationIdMiningObservers200OkList) {
...
func easyjsonB48e5cffEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationCorporationIdMiningObservers200OkList) {
...
func (v GetCorporationCorporationIdMiningObservers200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB48e5cffEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationCorporationIdMiningObservers200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB48e5cffDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationCorporationIdMiningObservers200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB48e5cffDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB48e5cffDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationCorporationIdMiningObservers200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB48e5cffEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationCorporationIdMiningObservers200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastUpdated != "" {
...
func (v GetCorporationCorporationIdMiningObservers200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB48e5cffEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationCorporationIdMiningObservers200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB48e5cffDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationCorporationIdMiningObservers200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB48e5cffDecodeGithubComContornoGoesiEsi1(l, v)
}
