...
func easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalActiveTotalList) {
...
func easyjsonD7eb8cedEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalActiveTotalList) {
...
func (v GetFwLeaderboardsActiveTotalActiveTotalList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD7eb8cedEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsActiveTotalActiveTotalList) UnmarshalJSON(data []byte) error {
	...
	easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotalActiveTotalList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalActiveTotal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD7eb8cedEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalActiveTotal) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsActiveTotalActiveTotal) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD7eb8cedEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsActiveTotalActiveTotal) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotalActiveTotal) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD7eb8cedDecodeGithubComContornoGoesiEsi1(l, v)
}
