...
func easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsRegionIdOrders200OkList) {
...
func easyjsonCdc2fd8fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsRegionIdOrders200OkList) {
...
func (v GetMarketsRegionIdOrders200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCdc2fd8fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsRegionIdOrders200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdOrders200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsRegionIdOrders200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCdc2fd8fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsRegionIdOrders200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Duration != 0 {
...
func (v GetMarketsRegionIdOrders200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCdc2fd8fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsRegionIdOrders200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdOrders200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCdc2fd8fDecodeGithubComContornoGoesiEsi1(l, v)
}
