...
func easyjson615b321bDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdFleetOkList) {
...
func easyjson615b321bEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdFleetOkList) {
...
func (v GetCharactersCharacterIdFleetOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson615b321bEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdFleetOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson615b321bDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFleetOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson615b321bDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson615b321bDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdFleetOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson615b321bEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdFleetOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FleetId != 0 {
...
func (v GetCharactersCharacterIdFleetOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson615b321bEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFleetOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson615b321bDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFleetOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson615b321bDecodeGithubComContornoGoesiEsi1(l, v)
}
