...
func easyjson727b990DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCharactersCharacterIdContactsError520List) {
...
func easyjson727b990EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCharactersCharacterIdContactsError520List) {
...
func (v PostCharactersCharacterIdContactsError520List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson727b990EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCharactersCharacterIdContactsError520List) UnmarshalJSON(data []byte) error {
	...
	easyjson727b990DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdContactsError520List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson727b990DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson727b990DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCharactersCharacterIdContactsError520) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson727b990EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCharactersCharacterIdContactsError520) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PostCharactersCharacterIdContactsError520) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson727b990EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdContactsError520) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson727b990DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdContactsError520) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson727b990DecodeGithubComContornoGoesiEsi1(l, v)
}
