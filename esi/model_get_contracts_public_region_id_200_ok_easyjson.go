...
func easyjsonE838f8a7DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetContractsPublicRegionId200OkList) {
...
func easyjsonE838f8a7EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetContractsPublicRegionId200OkList) {
...
func (v GetContractsPublicRegionId200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE838f8a7EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetContractsPublicRegionId200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE838f8a7DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetContractsPublicRegionId200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE838f8a7DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE838f8a7DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetContractsPublicRegionId200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE838f8a7EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetContractsPublicRegionId200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Buyout != 0 {
...
func (v GetContractsPublicRegionId200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE838f8a7EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetContractsPublicRegionId200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE838f8a7DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetContractsPublicRegionId200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE838f8a7DecodeGithubComContornoGoesiEsi1(l, v)
}
