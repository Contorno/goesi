...
func easyjson9ff9c362DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsLocationsPositionList) {
...
func easyjson9ff9c362EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsLocationsPositionList) {
...
func (v PostCorporationsCorporationIdAssetsLocationsPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9ff9c362EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCorporationsCorporationIdAssetsLocationsPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson9ff9c362DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsLocationsPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9ff9c362DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9ff9c362DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsLocationsPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9ff9c362EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsLocationsPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v PostCorporationsCorporationIdAssetsLocationsPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9ff9c362EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCorporationsCorporationIdAssetsLocationsPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9ff9c362DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsLocationsPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9ff9c362DecodeGithubComContornoGoesiEsi1(l, v)
}
