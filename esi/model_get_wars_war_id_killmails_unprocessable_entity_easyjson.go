...
func easyjson354ee051DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetWarsWarIdKillmailsUnprocessableEntityList) {
...
func easyjson354ee051EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetWarsWarIdKillmailsUnprocessableEntityList) {
...
func (v GetWarsWarIdKillmailsUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson354ee051EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetWarsWarIdKillmailsUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson354ee051DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdKillmailsUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson354ee051DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson354ee051DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdKillmailsUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson354ee051EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdKillmailsUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetWarsWarIdKillmailsUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson354ee051EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetWarsWarIdKillmailsUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson354ee051DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdKillmailsUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson354ee051DecodeGithubComContornoGoesiEsi1(l, v)
}
