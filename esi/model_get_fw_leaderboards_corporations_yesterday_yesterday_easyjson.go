...
func easyjson8ff736dbDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsYesterdayYesterdayList) {
...
func easyjson8ff736dbEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsYesterdayYesterdayList) {
...
func (v GetFwLeaderboardsCorporationsYesterdayYesterdayList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8ff736dbEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsYesterdayYesterdayList) UnmarshalJSON(data []byte) error {
	...
	easyjson8ff736dbDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsYesterdayYesterdayList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8ff736dbDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson8ff736dbDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsYesterdayYesterday) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8ff736dbEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsYesterdayYesterday) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsYesterdayYesterday) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8ff736dbEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsYesterdayYesterday) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8ff736dbDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsYesterdayYesterday) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8ff736dbDecodeGithubComContornoGoesiEsi1(l, v)
}
