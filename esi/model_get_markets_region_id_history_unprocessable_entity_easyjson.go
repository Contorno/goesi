...
func easyjson95f0199DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsRegionIdHistoryUnprocessableEntityList) {
...
func easyjson95f0199EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsRegionIdHistoryUnprocessableEntityList) {
...
func (v GetMarketsRegionIdHistoryUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson95f0199EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsRegionIdHistoryUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson95f0199DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistoryUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson95f0199DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson95f0199DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsRegionIdHistoryUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson95f0199EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsRegionIdHistoryUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetMarketsRegionIdHistoryUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson95f0199EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsRegionIdHistoryUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson95f0199DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistoryUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson95f0199DecodeGithubComContornoGoesiEsi1(l, v)
}
