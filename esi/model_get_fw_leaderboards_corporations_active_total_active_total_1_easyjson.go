...
func easyjson43a0dad3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1List) {
...
func easyjson43a0dad3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsActiveTotalActiveTotal1List) {
...
func (v GetFwLeaderboardsCorporationsActiveTotalActiveTotal1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson43a0dad3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1List) UnmarshalJSON(data []byte) error {
	...
	easyjson43a0dad3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson43a0dad3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson43a0dad3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson43a0dad3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsActiveTotalActiveTotal1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsActiveTotalActiveTotal1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson43a0dad3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson43a0dad3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson43a0dad3DecodeGithubComContornoGoesiEsi1(l, v)
}
