...
func easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseConstellationsConstellationIdPositionList) {
...
func easyjsonCfc1dd73EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseConstellationsConstellationIdPositionList) {
...
func (v GetUniverseConstellationsConstellationIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCfc1dd73EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseConstellationsConstellationIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseConstellationsConstellationIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseConstellationsConstellationIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCfc1dd73EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseConstellationsConstellationIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseConstellationsConstellationIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCfc1dd73EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseConstellationsConstellationIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseConstellationsConstellationIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCfc1dd73DecodeGithubComContornoGoesiEsi1(l, v)
}
