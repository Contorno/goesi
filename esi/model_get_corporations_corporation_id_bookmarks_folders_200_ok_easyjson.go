...
func easyjsonB6f122f3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksFolders200OkList) {
...
func easyjsonB6f122f3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksFolders200OkList) {
...
func (v GetCorporationsCorporationIdBookmarksFolders200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6f122f3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdBookmarksFolders200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB6f122f3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksFolders200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6f122f3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB6f122f3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksFolders200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB6f122f3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksFolders200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CreatorId != 0 {
...
func (v GetCorporationsCorporationIdBookmarksFolders200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6f122f3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdBookmarksFolders200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB6f122f3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksFolders200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6f122f3DecodeGithubComContornoGoesiEsi1(l, v)
}
