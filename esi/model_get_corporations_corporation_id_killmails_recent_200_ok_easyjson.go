...
func easyjson64c2c160DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdKillmailsRecent200OkList) {
...
func easyjson64c2c160EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdKillmailsRecent200OkList) {
...
func (v GetCorporationsCorporationIdKillmailsRecent200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson64c2c160EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdKillmailsRecent200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson64c2c160DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdKillmailsRecent200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson64c2c160DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson64c2c160DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdKillmailsRecent200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson64c2c160EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdKillmailsRecent200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.KillmailHash != "" {
...
func (v GetCorporationsCorporationIdKillmailsRecent200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson64c2c160EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdKillmailsRecent200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson64c2c160DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdKillmailsRecent200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson64c2c160DecodeGithubComContornoGoesiEsi1(l, v)
}
