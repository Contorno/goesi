...
func easyjson11262980DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdContractsContractIdBidsNotFoundList) {
...
func easyjson11262980EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdContractsContractIdBidsNotFoundList) {
...
func (v GetCharactersCharacterIdContractsContractIdBidsNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson11262980EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdContractsContractIdBidsNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson11262980DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContractsContractIdBidsNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson11262980DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson11262980DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdContractsContractIdBidsNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson11262980EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdContractsContractIdBidsNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCharactersCharacterIdContractsContractIdBidsNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson11262980EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdContractsContractIdBidsNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson11262980DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContractsContractIdBidsNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson11262980DecodeGithubComContornoGoesiEsi1(l, v)
}
