...
func easyjson2be9d997DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdPositionList) {
...
func easyjson2be9d997EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStructuresStructureIdPositionList) {
...
func (v GetUniverseStructuresStructureIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2be9d997EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStructuresStructureIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson2be9d997DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2be9d997DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson2be9d997DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2be9d997EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStructuresStructureIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseStructuresStructureIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2be9d997EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStructuresStructureIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2be9d997DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2be9d997DecodeGithubComContornoGoesiEsi1(l, v)
}
