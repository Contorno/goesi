...
func easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniversePlanetsPlanetIdPositionList) {
...
func easyjsonA3a9ecd1EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniversePlanetsPlanetIdPositionList) {
...
func (v GetUniversePlanetsPlanetIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA3a9ecd1EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniversePlanetsPlanetIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniversePlanetsPlanetIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniversePlanetsPlanetIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA3a9ecd1EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniversePlanetsPlanetIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniversePlanetsPlanetIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA3a9ecd1EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniversePlanetsPlanetIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniversePlanetsPlanetIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA3a9ecd1DecodeGithubComContornoGoesiEsi1(l, v)
}
