...
func easyjsonF64baf53DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsStructuresStructureId200OkList) {
...
func easyjsonF64baf53EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsStructuresStructureId200OkList) {
...
func (v GetMarketsStructuresStructureId200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF64baf53EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsStructuresStructureId200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF64baf53DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsStructuresStructureId200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF64baf53DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonF64baf53DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsStructuresStructureId200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF64baf53EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsStructuresStructureId200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Duration != 0 {
...
func (v GetMarketsStructuresStructureId200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF64baf53EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsStructuresStructureId200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF64baf53DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsStructuresStructureId200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF64baf53DecodeGithubComContornoGoesiEsi1(l, v)
}
