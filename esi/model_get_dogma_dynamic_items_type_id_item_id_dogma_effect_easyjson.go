...
func easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdDogmaEffectList) {
...
func easyjson6bd9f6ceEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdDogmaEffectList) {
...
func (v GetDogmaDynamicItemsTypeIdItemIdDogmaEffectList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6bd9f6ceEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaEffectList) UnmarshalJSON(data []byte) error {
	...
	easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaEffectList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6bd9f6ceEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) {
	out.RawByte('{')
	first := true
	_ = first
	if in.EffectId != 0 {
...
func (v GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6bd9f6ceEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6bd9f6ceDecodeGithubComContornoGoesiEsi1(l, v)
}
