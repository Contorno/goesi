...
func easyjson5b391bd0DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetLoyaltyStoresCorporationIdOffersNotFoundList) {
...
func easyjson5b391bd0EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetLoyaltyStoresCorporationIdOffersNotFoundList) {
...
func (v GetLoyaltyStoresCorporationIdOffersNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5b391bd0EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetLoyaltyStoresCorporationIdOffersNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson5b391bd0DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetLoyaltyStoresCorporationIdOffersNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5b391bd0DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5b391bd0DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetLoyaltyStoresCorporationIdOffersNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5b391bd0EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetLoyaltyStoresCorporationIdOffersNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetLoyaltyStoresCorporationIdOffersNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5b391bd0EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetLoyaltyStoresCorporationIdOffersNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5b391bd0DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetLoyaltyStoresCorporationIdOffersNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5b391bd0DecodeGithubComContornoGoesiEsi1(l, v)
}
