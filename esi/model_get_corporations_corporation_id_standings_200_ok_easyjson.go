...
func easyjson4628647dDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdStandings200OkList) {
...
func easyjson4628647dEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdStandings200OkList) {
...
func (v GetCorporationsCorporationIdStandings200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4628647dEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdStandings200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson4628647dDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStandings200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4628647dDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson4628647dDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdStandings200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4628647dEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdStandings200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FromId != 0 {
...
func (v GetCorporationsCorporationIdStandings200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4628647dEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdStandings200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4628647dDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStandings200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4628647dDecodeGithubComContornoGoesiEsi1(l, v)
}
