...
func easyjson147b9742DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseRegionsRegionIdOkList) {
...
func easyjson147b9742EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseRegionsRegionIdOkList) {
...
func (v GetUniverseRegionsRegionIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson147b9742EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseRegionsRegionIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson147b9742DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRegionsRegionIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson147b9742DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson147b9742DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseRegionsRegionIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson147b9742EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseRegionsRegionIdOk) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetUniverseRegionsRegionIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson147b9742EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseRegionsRegionIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson147b9742DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRegionsRegionIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson147b9742DecodeGithubComContornoGoesiEsi1(l, v)
}
