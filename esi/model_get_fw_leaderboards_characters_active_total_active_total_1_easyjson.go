...
func easyjson9fdffcd2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotalActiveTotal1List) {
...
func easyjson9fdffcd2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotalActiveTotal1List) {
...
func (v GetFwLeaderboardsCharactersActiveTotalActiveTotal1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9fdffcd2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal1List) UnmarshalJSON(data []byte) error {
	...
	easyjson9fdffcd2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9fdffcd2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9fdffcd2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotalActiveTotal1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9fdffcd2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotalActiveTotal1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersActiveTotalActiveTotal1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9fdffcd2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9fdffcd2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotalActiveTotal1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9fdffcd2DecodeGithubComContornoGoesiEsi1(l, v)
}
