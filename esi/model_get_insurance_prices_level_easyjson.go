...
func easyjson3770691bDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetInsurancePricesLevelList) {
...
func easyjson3770691bEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetInsurancePricesLevelList) {
...
func (v GetInsurancePricesLevelList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3770691bEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetInsurancePricesLevelList) UnmarshalJSON(data []byte) error {
	...
	easyjson3770691bDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePricesLevelList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3770691bDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3770691bDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetInsurancePricesLevel) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3770691bEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetInsurancePricesLevel) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Cost != 0 {
...
func (v GetInsurancePricesLevel) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3770691bEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetInsurancePricesLevel) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3770691bDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePricesLevel) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3770691bDecodeGithubComContornoGoesiEsi1(l, v)
}
