...
func easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseGroupsGroupIdOkList) {
...
func easyjsonE0d2a1b4EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseGroupsGroupIdOkList) {
...
func (v GetUniverseGroupsGroupIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE0d2a1b4EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseGroupsGroupIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseGroupsGroupIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseGroupsGroupIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE0d2a1b4EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseGroupsGroupIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CategoryId != 0 {
...
func (v GetUniverseGroupsGroupIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE0d2a1b4EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseGroupsGroupIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseGroupsGroupIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE0d2a1b4DecodeGithubComContornoGoesiEsi1(l, v)
}
