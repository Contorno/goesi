...
func easyjsonCd04e186DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetStatusOkList) {
...
func easyjsonCd04e186EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetStatusOkList) {
...
func (v GetStatusOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCd04e186EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetStatusOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCd04e186DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetStatusOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCd04e186DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCd04e186DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetStatusOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCd04e186EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetStatusOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Players != 0 {
...
func (v GetStatusOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCd04e186EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetStatusOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCd04e186DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetStatusOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCd04e186DecodeGithubComContornoGoesiEsi1(l, v)
}
