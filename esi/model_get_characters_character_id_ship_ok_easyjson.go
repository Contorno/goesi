...
func easyjson7f2db38bDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdShipOkList) {
...
func easyjson7f2db38bEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdShipOkList) {
...
func (v GetCharactersCharacterIdShipOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7f2db38bEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdShipOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson7f2db38bDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdShipOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7f2db38bDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson7f2db38bDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdShipOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7f2db38bEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdShipOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ShipItemId != 0 {
...
func (v GetCharactersCharacterIdShipOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7f2db38bEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdShipOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7f2db38bDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdShipOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7f2db38bDecodeGithubComContornoGoesiEsi1(l, v)
}
