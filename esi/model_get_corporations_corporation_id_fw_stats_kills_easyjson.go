...
func easyjson4cf5052fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdFwStatsKillsList) {
...
func easyjson4cf5052fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdFwStatsKillsList) {
...
func (v GetCorporationsCorporationIdFwStatsKillsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4cf5052fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdFwStatsKillsList) UnmarshalJSON(data []byte) error {
	...
	easyjson4cf5052fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFwStatsKillsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4cf5052fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson4cf5052fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdFwStatsKills) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4cf5052fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdFwStatsKills) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastWeek != 0 {
...
func (v GetCorporationsCorporationIdFwStatsKills) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4cf5052fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdFwStatsKills) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4cf5052fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFwStatsKills) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4cf5052fDecodeGithubComContornoGoesiEsi1(l, v)
}
