...
func easyjson2fbd70c3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetIndustrySystemsCostIndiceList) {
...
func easyjson2fbd70c3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetIndustrySystemsCostIndiceList) {
...
func (v GetIndustrySystemsCostIndiceList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2fbd70c3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetIndustrySystemsCostIndiceList) UnmarshalJSON(data []byte) error {
	...
	easyjson2fbd70c3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustrySystemsCostIndiceList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2fbd70c3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson2fbd70c3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetIndustrySystemsCostIndice) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2fbd70c3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetIndustrySystemsCostIndice) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Activity != "" {
...
func (v GetIndustrySystemsCostIndice) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2fbd70c3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetIndustrySystemsCostIndice) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2fbd70c3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustrySystemsCostIndice) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2fbd70c3DecodeGithubComContornoGoesiEsi1(l, v)
}
