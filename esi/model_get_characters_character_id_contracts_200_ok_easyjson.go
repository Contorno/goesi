...
func easyjsonAa810831DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdContracts200OkList) {
...
func easyjsonAa810831EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdContracts200OkList) {
...
func (v GetCharactersCharacterIdContracts200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAa810831EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdContracts200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonAa810831DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContracts200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAa810831DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonAa810831DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdContracts200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAa810831EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdContracts200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AcceptorId != 0 {
...
func (v GetCharactersCharacterIdContracts200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAa810831EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdContracts200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonAa810831DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContracts200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAa810831DecodeGithubComContornoGoesiEsi1(l, v)
}
