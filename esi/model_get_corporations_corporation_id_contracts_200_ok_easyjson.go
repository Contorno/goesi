...
func easyjson23965dafDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdContracts200OkList) {
...
func easyjson23965dafEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdContracts200OkList) {
...
func (v GetCorporationsCorporationIdContracts200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson23965dafEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdContracts200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson23965dafDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContracts200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson23965dafDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson23965dafDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdContracts200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson23965dafEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdContracts200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AcceptorId != 0 {
...
func (v GetCorporationsCorporationIdContracts200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson23965dafEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdContracts200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson23965dafDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContracts200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson23965dafDecodeGithubComContornoGoesiEsi1(l, v)
}
