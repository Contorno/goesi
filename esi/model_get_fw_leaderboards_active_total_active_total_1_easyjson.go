...
func easyjsonBff2d699DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalActiveTotal1List) {
...
func easyjsonBff2d699EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalActiveTotal1List) {
...
func (v GetFwLeaderboardsActiveTotalActiveTotal1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBff2d699EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsActiveTotalActiveTotal1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonBff2d699DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotalActiveTotal1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBff2d699DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonBff2d699DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalActiveTotal1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBff2d699EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalActiveTotal1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsActiveTotalActiveTotal1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBff2d699EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsActiveTotalActiveTotal1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonBff2d699DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotalActiveTotal1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBff2d699DecodeGithubComContornoGoesiEsi1(l, v)
}
