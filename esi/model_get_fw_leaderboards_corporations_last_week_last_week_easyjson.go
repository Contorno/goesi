...
func easyjsonBdb30a37DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeekLastWeekList) {
...
func easyjsonBdb30a37EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeekLastWeekList) {
...
func (v GetFwLeaderboardsCorporationsLastWeekLastWeekList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBdb30a37EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsLastWeekLastWeekList) UnmarshalJSON(data []byte) error {
	...
	easyjsonBdb30a37DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeekLastWeekList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBdb30a37DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonBdb30a37DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeekLastWeek) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBdb30a37EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeekLastWeek) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsLastWeekLastWeek) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBdb30a37EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsLastWeekLastWeek) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonBdb30a37DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeekLastWeek) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBdb30a37DecodeGithubComContornoGoesiEsi1(l, v)
}
