...
func easyjsonC68f7d55DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdDogmaAttributeList) {
...
func easyjsonC68f7d55EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdDogmaAttributeList) {
...
func (v GetDogmaDynamicItemsTypeIdItemIdDogmaAttributeList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC68f7d55EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaAttributeList) UnmarshalJSON(data []byte) error {
	...
	easyjsonC68f7d55DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaAttributeList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC68f7d55DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonC68f7d55DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC68f7d55EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AttributeId != 0 {
...
func (v GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC68f7d55EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC68f7d55DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC68f7d55DecodeGithubComContornoGoesiEsi1(l, v)
}
