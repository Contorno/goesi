...
func easyjsonE23e4f59DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsYesterdayYesterday1List) {
...
func easyjsonE23e4f59EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsYesterdayYesterday1List) {
...
func (v GetFwLeaderboardsYesterdayYesterday1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE23e4f59EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsYesterdayYesterday1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonE23e4f59DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterdayYesterday1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE23e4f59DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE23e4f59DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsYesterdayYesterday1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE23e4f59EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsYesterdayYesterday1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsYesterdayYesterday1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE23e4f59EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsYesterdayYesterday1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE23e4f59DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterdayYesterday1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE23e4f59DecodeGithubComContornoGoesiEsi1(l, v)
}
