...
func easyjson2bed092DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetOpportunitiesGroupsGroupIdOkList) {
...
func easyjson2bed092EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetOpportunitiesGroupsGroupIdOkList) {
...
func (v GetOpportunitiesGroupsGroupIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2bed092EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetOpportunitiesGroupsGroupIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson2bed092DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesGroupsGroupIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2bed092DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson2bed092DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetOpportunitiesGroupsGroupIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2bed092EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetOpportunitiesGroupsGroupIdOk) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetOpportunitiesGroupsGroupIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2bed092EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetOpportunitiesGroupsGroupIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2bed092DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesGroupsGroupIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2bed092DecodeGithubComContornoGoesiEsi1(l, v)
}
