...
func easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetIndustrySystems200OkList) {
...
func easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetIndustrySystems200OkList) {
...
func (v GetIndustrySystems200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetIndustrySystems200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustrySystems200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetIndustrySystems200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "cost_indices":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi2(in, &v4)
...
func easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetIndustrySystems200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.CostIndices) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v5, v6 := range in.CostIndices {
				...
				easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetIndustrySystems200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetIndustrySystems200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustrySystems200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjsonA4a1cff6DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetIndustrySystemsCostIndice) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA4a1cff6EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetIndustrySystemsCostIndice) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Activity != "" {
