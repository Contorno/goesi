...
func easyjson955c47c3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PutFleetsFleetIdNewSettingsList) {
...
func easyjson955c47c3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PutFleetsFleetIdNewSettingsList) {
...
func (v PutFleetsFleetIdNewSettingsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson955c47c3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PutFleetsFleetIdNewSettingsList) UnmarshalJSON(data []byte) error {
	...
	easyjson955c47c3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdNewSettingsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson955c47c3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson955c47c3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PutFleetsFleetIdNewSettings) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson955c47c3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PutFleetsFleetIdNewSettings) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IsFreeMove {
...
func (v PutFleetsFleetIdNewSettings) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson955c47c3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdNewSettings) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson955c47c3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdNewSettings) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson955c47c3DecodeGithubComContornoGoesiEsi1(l, v)
}
