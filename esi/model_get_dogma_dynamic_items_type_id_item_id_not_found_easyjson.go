...
func easyjsonDe982b46DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdNotFoundList) {
...
func easyjsonDe982b46EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdNotFoundList) {
...
func (v GetDogmaDynamicItemsTypeIdItemIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDe982b46EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaDynamicItemsTypeIdItemIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjsonDe982b46DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDe982b46DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonDe982b46DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDe982b46EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetDogmaDynamicItemsTypeIdItemIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDe982b46EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaDynamicItemsTypeIdItemIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDe982b46DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDe982b46DecodeGithubComContornoGoesiEsi1(l, v)
}
