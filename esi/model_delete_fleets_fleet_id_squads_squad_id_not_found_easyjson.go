...
func easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *DeleteFleetsFleetIdSquadsSquadIdNotFoundList) {
...
func easyjson3f3c4ce4EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in DeleteFleetsFleetIdSquadsSquadIdNotFoundList) {
...
func (v DeleteFleetsFleetIdSquadsSquadIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3f3c4ce4EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *DeleteFleetsFleetIdSquadsSquadIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DeleteFleetsFleetIdSquadsSquadIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *DeleteFleetsFleetIdSquadsSquadIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3f3c4ce4EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in DeleteFleetsFleetIdSquadsSquadIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v DeleteFleetsFleetIdSquadsSquadIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3f3c4ce4EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *DeleteFleetsFleetIdSquadsSquadIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DeleteFleetsFleetIdSquadsSquadIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3f3c4ce4DecodeGithubComContornoGoesiEsi1(l, v)
}
