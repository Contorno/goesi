...
func easyjson17d0f88bDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetAlliancesAllianceIdIconsOkList) {
...
func easyjson17d0f88bEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetAlliancesAllianceIdIconsOkList) {
...
func (v GetAlliancesAllianceIdIconsOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson17d0f88bEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetAlliancesAllianceIdIconsOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson17d0f88bDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdIconsOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson17d0f88bDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson17d0f88bDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetAlliancesAllianceIdIconsOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson17d0f88bEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetAlliancesAllianceIdIconsOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Px128x128 != "" {
...
func (v GetAlliancesAllianceIdIconsOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson17d0f88bEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetAlliancesAllianceIdIconsOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson17d0f88bDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdIconsOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson17d0f88bDecodeGithubComContornoGoesiEsi1(l, v)
}
