...
func easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdMailMailIdOkList) {
...
func easyjson3c1b7f3cEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdMailMailIdOkList) {
...
func (v GetCharactersCharacterIdMailMailIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c1b7f3cEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdMailMailIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailMailIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdMailMailIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c1b7f3cEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdMailMailIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Body != "" {
...
func (v GetCharactersCharacterIdMailMailIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c1b7f3cEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMailMailIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailMailIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c1b7f3cDecodeGithubComContornoGoesiEsi1(l, v)
}
