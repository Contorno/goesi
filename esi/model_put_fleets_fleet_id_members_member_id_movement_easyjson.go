...
func easyjsonCbc331dfDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdMovementList) {
...
func easyjsonCbc331dfEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdMovementList) {
...
func (v PutFleetsFleetIdMembersMemberIdMovementList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCbc331dfEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PutFleetsFleetIdMembersMemberIdMovementList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCbc331dfDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdMovementList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCbc331dfDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCbc331dfDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdMovement) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCbc331dfEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdMovement) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Role != "" {
...
func (v PutFleetsFleetIdMembersMemberIdMovement) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCbc331dfEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdMembersMemberIdMovement) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCbc331dfDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdMovement) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCbc331dfDecodeGithubComContornoGoesiEsi1(l, v)
}
