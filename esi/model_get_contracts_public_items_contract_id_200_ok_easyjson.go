...
func easyjson93df16c2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetContractsPublicItemsContractId200OkList) {
...
func easyjson93df16c2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetContractsPublicItemsContractId200OkList) {
...
func (v GetContractsPublicItemsContractId200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson93df16c2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetContractsPublicItemsContractId200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson93df16c2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetContractsPublicItemsContractId200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson93df16c2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson93df16c2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetContractsPublicItemsContractId200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson93df16c2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetContractsPublicItemsContractId200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetContractsPublicItemsContractId200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson93df16c2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetContractsPublicItemsContractId200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson93df16c2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetContractsPublicItemsContractId200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson93df16c2DecodeGithubComContornoGoesiEsi1(l, v)
}
