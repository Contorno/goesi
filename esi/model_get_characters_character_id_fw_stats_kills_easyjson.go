...
func easyjsonB6d15945DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdFwStatsKillsList) {
...
func easyjsonB6d15945EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdFwStatsKillsList) {
...
func (v GetCharactersCharacterIdFwStatsKillsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6d15945EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdFwStatsKillsList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB6d15945DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFwStatsKillsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6d15945DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB6d15945DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdFwStatsKills) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB6d15945EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdFwStatsKills) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastWeek != 0 {
...
func (v GetCharactersCharacterIdFwStatsKills) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6d15945EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFwStatsKills) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB6d15945DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFwStatsKills) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6d15945DecodeGithubComContornoGoesiEsi1(l, v)
}
