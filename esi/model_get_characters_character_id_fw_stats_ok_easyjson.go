...
func easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdFwStatsOkList) {
...
func easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdFwStatsOkList) {
...
func (v GetCharactersCharacterIdFwStatsOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdFwStatsOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFwStatsOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdFwStatsOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "kills":
			easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi2(in, &out.Kills)
		case "victory_points":
...
func easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdFwStatsOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CurrentRank != 0 {
	...
	if true {
		...
		easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi2(out, in.Kills)
	}
	if true {
...
func (v GetCharactersCharacterIdFwStatsOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFwStatsOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFwStatsOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjsonB9cd43f2DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdFwStatsKills) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB9cd43f2EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdFwStatsKills) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LastWeek != 0 {
