...
func easyjson417de55fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsCreatedList) {
...
func easyjson417de55fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCharactersCharacterIdFittingsCreatedList) {
...
func (v PostCharactersCharacterIdFittingsCreatedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson417de55fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCharactersCharacterIdFittingsCreatedList) UnmarshalJSON(data []byte) error {
	...
	easyjson417de55fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsCreatedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson417de55fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson417de55fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsCreated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson417de55fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCharactersCharacterIdFittingsCreated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FittingId != 0 {
...
func (v PostCharactersCharacterIdFittingsCreated) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson417de55fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdFittingsCreated) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson417de55fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsCreated) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson417de55fDecodeGithubComContornoGoesiEsi1(l, v)
}
