...
func easyjson64bbe2f3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsActiveTotalActiveTotalList) {
...
func easyjson64bbe2f3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsActiveTotalActiveTotalList) {
...
func (v GetFwLeaderboardsCorporationsActiveTotalActiveTotalList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson64bbe2f3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotalList) UnmarshalJSON(data []byte) error {
	...
	easyjson64bbe2f3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotalList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson64bbe2f3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson64bbe2f3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsActiveTotalActiveTotal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson64bbe2f3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsActiveTotalActiveTotal) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsActiveTotalActiveTotal) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson64bbe2f3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson64bbe2f3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsActiveTotalActiveTotal) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson64bbe2f3DecodeGithubComContornoGoesiEsi1(l, v)
}
