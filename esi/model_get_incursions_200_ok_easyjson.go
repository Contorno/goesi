...
func easyjsonAb919c82DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetIncursions200OkList) {
...
func easyjsonAb919c82EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetIncursions200OkList) {
...
func (v GetIncursions200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAb919c82EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetIncursions200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonAb919c82DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIncursions200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAb919c82DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonAb919c82DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetIncursions200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAb919c82EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetIncursions200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetIncursions200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAb919c82EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetIncursions200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonAb919c82DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIncursions200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAb919c82DecodeGithubComContornoGoesiEsi1(l, v)
}
