...
func easyjson80080329DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdContactsLabels200OkList) {
...
func easyjson80080329EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdContactsLabels200OkList) {
...
func (v GetCorporationsCorporationIdContactsLabels200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson80080329EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdContactsLabels200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson80080329DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContactsLabels200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson80080329DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson80080329DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdContactsLabels200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson80080329EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdContactsLabels200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LabelId != 0 {
...
func (v GetCorporationsCorporationIdContactsLabels200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson80080329EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdContactsLabels200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson80080329DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContactsLabels200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson80080329DecodeGithubComContornoGoesiEsi1(l, v)
}
