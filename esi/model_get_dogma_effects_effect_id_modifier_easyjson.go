...
func easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdModifierList) {
...
func easyjsonAd79ccc0EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaEffectsEffectIdModifierList) {
...
func (v GetDogmaEffectsEffectIdModifierList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAd79ccc0EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaEffectsEffectIdModifierList) UnmarshalJSON(data []byte) error {
	...
	easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdModifierList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdModifier) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAd79ccc0EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaEffectsEffectIdModifier) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Domain != "" {
...
func (v GetDogmaEffectsEffectIdModifier) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAd79ccc0EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaEffectsEffectIdModifier) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdModifier) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAd79ccc0DecodeGithubComContornoGoesiEsi1(l, v)
}
