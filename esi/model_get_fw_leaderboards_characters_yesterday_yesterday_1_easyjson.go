...
func easyjsonFabd8426DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersYesterdayYesterday1List) {
...
func easyjsonFabd8426EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersYesterdayYesterday1List) {
...
func (v GetFwLeaderboardsCharactersYesterdayYesterday1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFabd8426EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersYesterdayYesterday1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonFabd8426DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersYesterdayYesterday1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFabd8426DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFabd8426DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersYesterdayYesterday1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFabd8426EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersYesterdayYesterday1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersYesterdayYesterday1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFabd8426EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersYesterdayYesterday1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFabd8426DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersYesterdayYesterday1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFabd8426DecodeGithubComContornoGoesiEsi1(l, v)
}
