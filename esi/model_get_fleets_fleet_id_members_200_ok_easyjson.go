...
func easyjson3a1ded9fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFleetsFleetIdMembers200OkList) {
...
func easyjson3a1ded9fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFleetsFleetIdMembers200OkList) {
...
func (v GetFleetsFleetIdMembers200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3a1ded9fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFleetsFleetIdMembers200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson3a1ded9fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFleetsFleetIdMembers200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3a1ded9fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3a1ded9fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFleetsFleetIdMembers200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3a1ded9fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFleetsFleetIdMembers200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetFleetsFleetIdMembers200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3a1ded9fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFleetsFleetIdMembers200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3a1ded9fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFleetsFleetIdMembers200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3a1ded9fDecodeGithubComContornoGoesiEsi1(l, v)
}
