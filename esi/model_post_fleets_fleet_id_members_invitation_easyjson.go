...
func easyjsonFf081cddDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostFleetsFleetIdMembersInvitationList) {
...
func easyjsonFf081cddEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostFleetsFleetIdMembersInvitationList) {
...
func (v PostFleetsFleetIdMembersInvitationList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFf081cddEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostFleetsFleetIdMembersInvitationList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFf081cddDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdMembersInvitationList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFf081cddDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFf081cddDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostFleetsFleetIdMembersInvitation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFf081cddEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostFleetsFleetIdMembersInvitation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v PostFleetsFleetIdMembersInvitation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFf081cddEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostFleetsFleetIdMembersInvitation) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFf081cddDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdMembersInvitation) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFf081cddDecodeGithubComContornoGoesiEsi1(l, v)
}
