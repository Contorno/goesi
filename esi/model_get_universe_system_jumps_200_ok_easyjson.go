...
func easyjsonE1f48832DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseSystemJumps200OkList) {
...
func easyjsonE1f48832EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseSystemJumps200OkList) {
...
func (v GetUniverseSystemJumps200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE1f48832EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseSystemJumps200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE1f48832DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemJumps200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE1f48832DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE1f48832DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseSystemJumps200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE1f48832EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseSystemJumps200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ShipJumps != 0 {
...
func (v GetUniverseSystemJumps200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE1f48832EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSystemJumps200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE1f48832DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemJumps200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE1f48832DecodeGithubComContornoGoesiEsi1(l, v)
}
