...
func easyjsonEd2aa520DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdItemsError520List) {
...
func easyjsonEd2aa520EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdItemsError520List) {
...
func (v GetCorporationsCorporationIdContractsContractIdItemsError520List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEd2aa520EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdContractsContractIdItemsError520List) UnmarshalJSON(data []byte) error {
	...
	easyjsonEd2aa520DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdItemsError520List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEd2aa520DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonEd2aa520DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdItemsError520) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEd2aa520EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdItemsError520) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCorporationsCorporationIdContractsContractIdItemsError520) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEd2aa520EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdContractsContractIdItemsError520) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEd2aa520DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdItemsError520) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEd2aa520DecodeGithubComContornoGoesiEsi1(l, v)
}
