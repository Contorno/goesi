...
func easyjsonCccd358cDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdOkList) {
...
func easyjsonCccd358cEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStructuresStructureIdOkList) {
...
func (v GetUniverseStructuresStructureIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCccd358cEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStructuresStructureIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCccd358cDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCccd358cDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonCccd358cDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCccd358cEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStructuresStructureIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func (v GetUniverseStructuresStructureIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCccd358cEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStructuresStructureIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCccd358cDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCccd358cDecodeGithubComContornoGoesiEsi1(l, v)
}
