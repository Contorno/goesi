...
func easyjson68d0aa8cDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdShareholders200OkList) {
...
func easyjson68d0aa8cEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdShareholders200OkList) {
...
func (v GetCorporationsCorporationIdShareholders200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson68d0aa8cEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdShareholders200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson68d0aa8cDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdShareholders200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson68d0aa8cDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson68d0aa8cDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdShareholders200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson68d0aa8cEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdShareholders200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ShareCount != 0 {
...
func (v GetCorporationsCorporationIdShareholders200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson68d0aa8cEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdShareholders200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson68d0aa8cDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdShareholders200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson68d0aa8cDecodeGithubComContornoGoesiEsi1(l, v)
}
