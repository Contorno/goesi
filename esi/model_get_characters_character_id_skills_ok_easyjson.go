...
func easyjson275affcbDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillsOkList) {
...
func easyjson275affcbEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdSkillsOkList) {
...
func (v GetCharactersCharacterIdSkillsOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson275affcbEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdSkillsOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson275affcbDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillsOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson275affcbDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson275affcbDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillsOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "skills":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson275affcbDecodeGithubComContornoGoesiEsi2(in, &v4)
...
func easyjson275affcbEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdSkillsOk) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Skills) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v5, v6 := range in.Skills {
				...
				easyjson275affcbEncodeGithubComContornoGoesiEsi2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdSkillsOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson275affcbEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdSkillsOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson275affcbDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillsOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson275affcbDecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson275affcbDecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillsSkill) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson275affcbEncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdSkillsSkill) {
	out.RawByte('{')
	first := true
	_ = first
