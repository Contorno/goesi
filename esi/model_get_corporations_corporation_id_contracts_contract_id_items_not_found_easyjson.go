...
func easyjson3e5cad92DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdItemsNotFoundList) {
...
func easyjson3e5cad92EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdItemsNotFoundList) {
...
func (v GetCorporationsCorporationIdContractsContractIdItemsNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3e5cad92EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdContractsContractIdItemsNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson3e5cad92DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdItemsNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3e5cad92DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3e5cad92DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdItemsNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e5cad92EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdItemsNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCorporationsCorporationIdContractsContractIdItemsNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3e5cad92EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdContractsContractIdItemsNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3e5cad92DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdItemsNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3e5cad92DecodeGithubComContornoGoesiEsi1(l, v)
}
