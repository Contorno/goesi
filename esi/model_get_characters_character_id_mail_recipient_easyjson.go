...
func easyjson51b6d5c7DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdMailRecipientList) {
...
func easyjson51b6d5c7EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdMailRecipientList) {
...
func (v GetCharactersCharacterIdMailRecipientList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson51b6d5c7EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdMailRecipientList) UnmarshalJSON(data []byte) error {
	...
	easyjson51b6d5c7DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailRecipientList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson51b6d5c7DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson51b6d5c7DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdMailRecipient) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson51b6d5c7EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdMailRecipient) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RecipientId != 0 {
...
func (v GetCharactersCharacterIdMailRecipient) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson51b6d5c7EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMailRecipient) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson51b6d5c7DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailRecipient) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson51b6d5c7DecodeGithubComContornoGoesiEsi1(l, v)
}
