...
func easyjson729ea2d8DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdFittings200OkList) {
...
func easyjson729ea2d8EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdFittings200OkList) {
...
func (v GetCharactersCharacterIdFittings200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson729ea2d8EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdFittings200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson729ea2d8DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittings200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson729ea2d8DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson729ea2d8DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdFittings200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson729ea2d8DecodeGithubComContornoGoesiEsi2(in, &v4)
...
func easyjson729ea2d8EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdFittings200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
	...
	if len(in.Items) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Items {
				...
				easyjson729ea2d8EncodeGithubComContornoGoesiEsi2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdFittings200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson729ea2d8EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFittings200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson729ea2d8DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittings200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson729ea2d8DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson729ea2d8DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdFittingsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson729ea2d8EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdFittingsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != "" {
