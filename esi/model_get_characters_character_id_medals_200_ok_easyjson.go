...
func easyjson88215edcDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdMedals200OkList) {
...
func easyjson88215edcEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdMedals200OkList) {
...
func (v GetCharactersCharacterIdMedals200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson88215edcEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdMedals200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson88215edcDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMedals200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson88215edcDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson88215edcDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdMedals200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "graphics":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson88215edcDecodeGithubComContornoGoesiEsi2(in, &v4)
...
func easyjson88215edcEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdMedals200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.Graphics) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Graphics {
				...
				easyjson88215edcEncodeGithubComContornoGoesiEsi2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdMedals200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson88215edcEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMedals200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson88215edcDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMedals200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson88215edcDecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson88215edcDecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdMedalsGraphic) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson88215edcEncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdMedalsGraphic) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Color != 0 {
