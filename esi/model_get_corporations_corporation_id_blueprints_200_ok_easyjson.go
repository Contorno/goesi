...
func easyjson173baafaDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdBlueprints200OkList) {
...
func easyjson173baafaEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdBlueprints200OkList) {
...
func (v GetCorporationsCorporationIdBlueprints200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson173baafaEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdBlueprints200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson173baafaDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBlueprints200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson173baafaDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson173baafaDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdBlueprints200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson173baafaEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdBlueprints200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ItemId != 0 {
...
func (v GetCorporationsCorporationIdBlueprints200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson173baafaEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdBlueprints200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson173baafaDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBlueprints200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson173baafaDecodeGithubComContornoGoesiEsi1(l, v)
}
