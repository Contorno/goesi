...
func easyjson4323e5f7DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksItemList) {
...
func easyjson4323e5f7EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksItemList) {
...
func (v GetCorporationsCorporationIdBookmarksItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4323e5f7EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdBookmarksItemList) UnmarshalJSON(data []byte) error {
	...
	easyjson4323e5f7DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4323e5f7DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson4323e5f7DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdBookmarksItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4323e5f7EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdBookmarksItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ItemId != 0 {
...
func (v GetCorporationsCorporationIdBookmarksItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4323e5f7EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdBookmarksItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4323e5f7DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdBookmarksItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4323e5f7DecodeGithubComContornoGoesiEsi1(l, v)
}
