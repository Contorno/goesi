...
func easyjsonDac132eeDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFleetsFleetIdOkList) {
...
func easyjsonDac132eeEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFleetsFleetIdOkList) {
...
func (v GetFleetsFleetIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDac132eeEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFleetsFleetIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonDac132eeDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFleetsFleetIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDac132eeDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonDac132eeDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFleetsFleetIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDac132eeEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFleetsFleetIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IsFreeMove {
...
func (v GetFleetsFleetIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDac132eeEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFleetsFleetIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDac132eeDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFleetsFleetIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDac132eeDecodeGithubComContornoGoesiEsi1(l, v)
}
