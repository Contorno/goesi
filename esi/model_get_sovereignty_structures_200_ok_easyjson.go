...
func easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetSovereigntyStructures200OkList) {
...
func easyjson1e8c5b0bEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetSovereigntyStructures200OkList) {
...
func (v GetSovereigntyStructures200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1e8c5b0bEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetSovereigntyStructures200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyStructures200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetSovereigntyStructures200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1e8c5b0bEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetSovereigntyStructures200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetSovereigntyStructures200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1e8c5b0bEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetSovereigntyStructures200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyStructures200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1e8c5b0bDecodeGithubComContornoGoesiEsi1(l, v)
}
