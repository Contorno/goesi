...
func easyjson7c9005b1DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetAlliancesAllianceIdContactsLabels200OkList) {
...
func easyjson7c9005b1EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetAlliancesAllianceIdContactsLabels200OkList) {
...
func (v GetAlliancesAllianceIdContactsLabels200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c9005b1EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetAlliancesAllianceIdContactsLabels200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson7c9005b1DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdContactsLabels200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c9005b1DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson7c9005b1DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetAlliancesAllianceIdContactsLabels200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c9005b1EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetAlliancesAllianceIdContactsLabels200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LabelId != 0 {
...
func (v GetAlliancesAllianceIdContactsLabels200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c9005b1EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetAlliancesAllianceIdContactsLabels200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c9005b1DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdContactsLabels200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c9005b1DecodeGithubComContornoGoesiEsi1(l, v)
}
