...
func easyjsonE2766578DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdBlueprints200OkList) {
...
func easyjsonE2766578EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdBlueprints200OkList) {
...
func (v GetCharactersCharacterIdBlueprints200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE2766578EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdBlueprints200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE2766578DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBlueprints200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE2766578DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE2766578DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdBlueprints200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE2766578EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdBlueprints200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ItemId != 0 {
...
func (v GetCharactersCharacterIdBlueprints200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE2766578EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdBlueprints200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE2766578DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBlueprints200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE2766578DecodeGithubComContornoGoesiEsi1(l, v)
}
