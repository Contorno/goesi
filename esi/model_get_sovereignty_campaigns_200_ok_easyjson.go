...
func easyjsonA4228502DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetSovereigntyCampaigns200OkList) {
...
func easyjsonA4228502EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetSovereigntyCampaigns200OkList) {
...
func (v GetSovereigntyCampaigns200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA4228502EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetSovereigntyCampaigns200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonA4228502DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyCampaigns200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA4228502DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonA4228502DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetSovereigntyCampaigns200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA4228502EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetSovereigntyCampaigns200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetSovereigntyCampaigns200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA4228502EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetSovereigntyCampaigns200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonA4228502DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyCampaigns200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA4228502DecodeGithubComContornoGoesiEsi1(l, v)
}
