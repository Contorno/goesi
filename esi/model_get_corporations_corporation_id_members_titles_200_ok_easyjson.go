...
func easyjson640f619dDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdMembersTitles200OkList) {
...
func easyjson640f619dEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdMembersTitles200OkList) {
...
func (v GetCorporationsCorporationIdMembersTitles200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson640f619dEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdMembersTitles200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson640f619dDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMembersTitles200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson640f619dDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson640f619dDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdMembersTitles200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson640f619dEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdMembersTitles200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetCorporationsCorporationIdMembersTitles200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson640f619dEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdMembersTitles200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson640f619dDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMembersTitles200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson640f619dDecodeGithubComContornoGoesiEsi1(l, v)
}
