...
func easyjson3d42ac67DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) {
...
func easyjson3d42ac67EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3d42ac67EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson3d42ac67DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3d42ac67DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3d42ac67DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3d42ac67EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3d42ac67EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3d42ac67DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3d42ac67DecodeGithubComContornoGoesiEsi1(l, v)
}
