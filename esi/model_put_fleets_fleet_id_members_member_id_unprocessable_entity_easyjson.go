...
func easyjson36c27bdeDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdUnprocessableEntityList) {
...
func easyjson36c27bdeEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdUnprocessableEntityList) {
...
func (v PutFleetsFleetIdMembersMemberIdUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson36c27bdeEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PutFleetsFleetIdMembersMemberIdUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson36c27bdeDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson36c27bdeDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson36c27bdeDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson36c27bdeEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PutFleetsFleetIdMembersMemberIdUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson36c27bdeEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdMembersMemberIdUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson36c27bdeDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson36c27bdeDecodeGithubComContornoGoesiEsi1(l, v)
}
