...
func easyjson5cc83670DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsNames200OkList) {
...
func easyjson5cc83670EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsNames200OkList) {
...
func (v PostCorporationsCorporationIdAssetsNames200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5cc83670EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCorporationsCorporationIdAssetsNames200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5cc83670DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsNames200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5cc83670DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5cc83670DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsNames200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5cc83670EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsNames200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ItemId != 0 {
...
func (v PostCorporationsCorporationIdAssetsNames200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5cc83670EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCorporationsCorporationIdAssetsNames200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5cc83670DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsNames200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5cc83670DecodeGithubComContornoGoesiEsi1(l, v)
}
