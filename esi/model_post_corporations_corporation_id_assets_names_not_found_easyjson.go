...
func easyjson384fe315DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsNamesNotFoundList) {
...
func easyjson384fe315EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsNamesNotFoundList) {
...
func (v PostCorporationsCorporationIdAssetsNamesNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson384fe315EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PostCorporationsCorporationIdAssetsNamesNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson384fe315DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsNamesNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson384fe315DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson384fe315DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PostCorporationsCorporationIdAssetsNamesNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson384fe315EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PostCorporationsCorporationIdAssetsNamesNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PostCorporationsCorporationIdAssetsNamesNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson384fe315EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCorporationsCorporationIdAssetsNamesNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson384fe315DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCorporationsCorporationIdAssetsNamesNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson384fe315DecodeGithubComContornoGoesiEsi1(l, v)
}
