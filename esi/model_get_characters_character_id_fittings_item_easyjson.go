...
func easyjson43ca1e42DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdFittingsItemList) {
...
func easyjson43ca1e42EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdFittingsItemList) {
...
func (v GetCharactersCharacterIdFittingsItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson43ca1e42EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdFittingsItemList) UnmarshalJSON(data []byte) error {
	...
	easyjson43ca1e42DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittingsItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson43ca1e42DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson43ca1e42DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdFittingsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson43ca1e42EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdFittingsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != "" {
...
func (v GetCharactersCharacterIdFittingsItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson43ca1e42EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFittingsItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson43ca1e42DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittingsItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson43ca1e42DecodeGithubComContornoGoesiEsi1(l, v)
}
