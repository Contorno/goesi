...
func easyjsonB29675b3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetIndustryFacilities200OkList) {
...
func easyjsonB29675b3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetIndustryFacilities200OkList) {
...
func (v GetIndustryFacilities200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB29675b3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetIndustryFacilities200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB29675b3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustryFacilities200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB29675b3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB29675b3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetIndustryFacilities200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB29675b3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetIndustryFacilities200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FacilityId != 0 {
...
func (v GetIndustryFacilities200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB29675b3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetIndustryFacilities200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB29675b3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetIndustryFacilities200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB29675b3DecodeGithubComContornoGoesiEsi1(l, v)
}
