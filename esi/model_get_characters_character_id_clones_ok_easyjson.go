...
func easyjson13ace497DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesOkList) {
...
func easyjson13ace497EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdClonesOkList) {
...
func (v GetCharactersCharacterIdClonesOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson13ace497EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdClonesOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson13ace497DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson13ace497DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson13ace497DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "home_location":
			easyjson13ace497DecodeGithubComContornoGoesiEsi2(in, &out.HomeLocation)
		case "jump_clones":
			if in.IsNull() {
				in.Skip()
				out.JumpClones = nil
...
func easyjson13ace497EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdClonesOk) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
		...
		easyjson13ace497EncodeGithubComContornoGoesiEsi2(out, in.HomeLocation)
	}
...
func (v GetCharactersCharacterIdClonesOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson13ace497EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdClonesOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson13ace497DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson13ace497DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson13ace497DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesHomeLocation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson13ace497EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdClonesHomeLocation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LocationId != 0 {
