...
func easyjson3951f242DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsHangarHangarList) {
...
func easyjson3951f242EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsHangarHangarList) {
...
func (v GetCorporationsCorporationIdDivisionsHangarHangarList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3951f242EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdDivisionsHangarHangarList) UnmarshalJSON(data []byte) error {
	...
	easyjson3951f242DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsHangarHangarList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3951f242DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3951f242DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsHangarHangar) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3951f242EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsHangarHangar) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Division != 0 {
...
func (v GetCorporationsCorporationIdDivisionsHangarHangar) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3951f242EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdDivisionsHangarHangar) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3951f242DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsHangarHangar) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3951f242DecodeGithubComContornoGoesiEsi1(l, v)
}
