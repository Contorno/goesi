...
func easyjson29210505DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func easyjson29210505EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson29210505EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson29210505DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson29210505DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson29210505DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "pins":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson29210505DecodeGithubComContornoGoesiEsi2(in, &v5)
		...
		case "routes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson29210505DecodeGithubComContornoGoesiEsi3(in, &v6)
...
func easyjson29210505EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Links) != 0 {
	...
	if len(in.Pins) != 0 {
		...
		}
		{
			...
			for v9, v10 := range in.Pins {
				...
				easyjson29210505EncodeGithubComContornoGoesiEsi2(out, v10)
			}
			out.RawByte(']')
		}
	}
	if len(in.Routes) != 0 {
		...
		}
		{
			...
			for v11, v12 := range in.Routes {
				...
				easyjson29210505EncodeGithubComContornoGoesiEsi3(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson29210505EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson29210505DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson29210505DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson29210505DecodeGithubComContornoGoesiEsi3(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29210505EncodeGithubComContornoGoesiEsi3(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson29210505DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdPin) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "contents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson29210505DecodeGithubComContornoGoesiEsi4(in, &v16)
		...
		case "extractor_details":
			easyjson29210505DecodeGithubComContornoGoesiEsi5(in, &out.ExtractorDetails)
		case "factory_details":
			easyjson29210505DecodeGithubComContornoGoesiEsi6(in, &out.FactoryDetails)
		case "install_time":
			if data := in.Raw(); in.Ok() {
...
func easyjson29210505EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdPin) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Contents) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v17, v18 := range in.Contents {
				...
				easyjson29210505EncodeGithubComContornoGoesiEsi4(out, v18)
			}
			out.RawByte(']')
		}
	}
	...
	if true {
		...
		easyjson29210505EncodeGithubComContornoGoesiEsi5(out, in.ExtractorDetails)
	}
	if true {
		...
		easyjson29210505EncodeGithubComContornoGoesiEsi6(out, in.FactoryDetails)
	}
	if true {
...
func easyjson29210505DecodeGithubComContornoGoesiEsi6(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdFactoryDetails) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29210505EncodeGithubComContornoGoesiEsi6(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdFactoryDetails) {
	out.RawByte('{')
	first := true
	_ = first
	if in.SchematicId != 0 {
...
func easyjson29210505DecodeGithubComContornoGoesiEsi5(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "heads":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson29210505DecodeGithubComContornoGoesiEsi7(in, &v19)
...
func easyjson29210505EncodeGithubComContornoGoesiEsi5(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CycleTime != 0 {
	...
	if len(in.Heads) != 0 {
		...
		}
		{
			...
			for v20, v21 := range in.Heads {
				...
				easyjson29210505EncodeGithubComContornoGoesiEsi7(out, v21)
			}
			out.RawByte(']')
		}
	}
...
func easyjson29210505DecodeGithubComContornoGoesiEsi7(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdHead) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29210505EncodeGithubComContornoGoesiEsi7(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdHead) {
	out.RawByte('{')
	first := true
	_ = first
	if in.HeadId != 0 {
...
func easyjson29210505DecodeGithubComContornoGoesiEsi4(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdContent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson29210505EncodeGithubComContornoGoesiEsi4(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdContent) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
