...
func easyjson3625572aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsRegionIdOrdersUnprocessableEntityList) {
...
func easyjson3625572aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsRegionIdOrdersUnprocessableEntityList) {
...
func (v GetMarketsRegionIdOrdersUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3625572aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsRegionIdOrdersUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson3625572aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdOrdersUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3625572aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson3625572aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsRegionIdOrdersUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3625572aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsRegionIdOrdersUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetMarketsRegionIdOrdersUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3625572aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsRegionIdOrdersUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3625572aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdOrdersUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3625572aDecodeGithubComContornoGoesiEsi1(l, v)
}
