...
func easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdBidsNotFoundList) {
...
func easyjsonFcb7afbeEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdBidsNotFoundList) {
...
func (v GetCorporationsCorporationIdContractsContractIdBidsNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFcb7afbeEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdContractsContractIdBidsNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdBidsNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdContractsContractIdBidsNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFcb7afbeEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdContractsContractIdBidsNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCorporationsCorporationIdContractsContractIdBidsNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFcb7afbeEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdContractsContractIdBidsNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdContractsContractIdBidsNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFcb7afbeDecodeGithubComContornoGoesiEsi1(l, v)
}
