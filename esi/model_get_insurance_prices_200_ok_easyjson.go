...
func easyjson24365b2aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetInsurancePrices200OkList) {
...
func easyjson24365b2aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetInsurancePrices200OkList) {
...
func (v GetInsurancePrices200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson24365b2aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetInsurancePrices200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson24365b2aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePrices200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson24365b2aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson24365b2aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetInsurancePrices200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson24365b2aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetInsurancePrices200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Levels) != 0 {
...
func (v GetInsurancePrices200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson24365b2aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetInsurancePrices200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson24365b2aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePrices200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson24365b2aDecodeGithubComContornoGoesiEsi1(l, v)
}
