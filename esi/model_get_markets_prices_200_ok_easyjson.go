...
func easyjsonC80ffb65DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetMarketsPrices200OkList) {
...
func easyjsonC80ffb65EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetMarketsPrices200OkList) {
...
func (v GetMarketsPrices200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC80ffb65EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetMarketsPrices200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonC80ffb65DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsPrices200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC80ffb65DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonC80ffb65DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetMarketsPrices200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ffb65EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetMarketsPrices200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetMarketsPrices200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC80ffb65EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsPrices200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC80ffb65DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsPrices200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC80ffb65DecodeGithubComContornoGoesiEsi1(l, v)
}
