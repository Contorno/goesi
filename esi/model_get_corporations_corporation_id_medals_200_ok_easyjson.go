...
func easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdMedals200OkList) {
...
func easyjsonB6f9bc1aEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdMedals200OkList) {
...
func (v GetCorporationsCorporationIdMedals200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6f9bc1aEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdMedals200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMedals200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdMedals200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB6f9bc1aEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdMedals200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCorporationsCorporationIdMedals200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB6f9bc1aEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdMedals200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdMedals200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB6f9bc1aDecodeGithubComContornoGoesiEsi1(l, v)
}
