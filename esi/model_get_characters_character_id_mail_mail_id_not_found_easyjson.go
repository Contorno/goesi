...
func easyjson9d4733eeDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdMailMailIdNotFoundList) {
...
func easyjson9d4733eeEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdMailMailIdNotFoundList) {
...
func (v GetCharactersCharacterIdMailMailIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9d4733eeEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdMailMailIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson9d4733eeDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailMailIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9d4733eeDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson9d4733eeDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdMailMailIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9d4733eeEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdMailMailIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetCharactersCharacterIdMailMailIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9d4733eeEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMailMailIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9d4733eeDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailMailIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9d4733eeDecodeGithubComContornoGoesiEsi1(l, v)
}
