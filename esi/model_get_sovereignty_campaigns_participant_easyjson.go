...
func easyjson39b04daDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetSovereigntyCampaignsParticipantList) {
...
func easyjson39b04daEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetSovereigntyCampaignsParticipantList) {
...
func (v GetSovereigntyCampaignsParticipantList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson39b04daEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetSovereigntyCampaignsParticipantList) UnmarshalJSON(data []byte) error {
	...
	easyjson39b04daDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyCampaignsParticipantList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson39b04daDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson39b04daDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetSovereigntyCampaignsParticipant) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson39b04daEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetSovereigntyCampaignsParticipant) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetSovereigntyCampaignsParticipant) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson39b04daEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetSovereigntyCampaignsParticipant) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson39b04daDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyCampaignsParticipant) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson39b04daDecodeGithubComContornoGoesiEsi1(l, v)
}
