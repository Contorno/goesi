...
func easyjsonFdb86af1DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeekLastWeekList) {
...
func easyjsonFdb86af1EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsLastWeekLastWeekList) {
...
func (v GetFwLeaderboardsLastWeekLastWeekList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFdb86af1EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsLastWeekLastWeekList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFdb86af1DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeekLastWeekList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFdb86af1DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFdb86af1DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeekLastWeek) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFdb86af1EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsLastWeekLastWeek) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsLastWeekLastWeek) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFdb86af1EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsLastWeekLastWeek) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFdb86af1DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeekLastWeek) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFdb86af1DecodeGithubComContornoGoesiEsi1(l, v)
}
