...
func easyjsonFddeaa82DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStarsStarIdOkList) {
...
func easyjsonFddeaa82EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStarsStarIdOkList) {
...
func (v GetUniverseStarsStarIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFddeaa82EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStarsStarIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFddeaa82DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStarsStarIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFddeaa82DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFddeaa82DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStarsStarIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFddeaa82EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStarsStarIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Age != 0 {
...
func (v GetUniverseStarsStarIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFddeaa82EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStarsStarIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFddeaa82DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStarsStarIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFddeaa82DecodeGithubComContornoGoesiEsi1(l, v)
}
