...
func easyjson7d2a820dDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStationsStationIdPositionList) {
...
func easyjson7d2a820dEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStationsStationIdPositionList) {
...
func (v GetUniverseStationsStationIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7d2a820dEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStationsStationIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson7d2a820dDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7d2a820dDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson7d2a820dDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStationsStationIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7d2a820dEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStationsStationIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseStationsStationIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7d2a820dEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStationsStationIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7d2a820dDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStationsStationIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7d2a820dDecodeGithubComContornoGoesiEsi1(l, v)
}
