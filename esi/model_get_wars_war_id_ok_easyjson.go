...
func easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetWarsWarIdOkList) {
...
func easyjsonF6dfc9daEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetWarsWarIdOkList) {
...
func (v GetWarsWarIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF6dfc9daEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetWarsWarIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6dfc9daEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetWarsWarIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF6dfc9daEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetWarsWarIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF6dfc9daDecodeGithubComContornoGoesiEsi1(l, v)
}
