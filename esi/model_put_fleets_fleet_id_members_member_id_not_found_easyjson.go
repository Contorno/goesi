...
func easyjson74e192f8DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdNotFoundList) {
...
func easyjson74e192f8EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdNotFoundList) {
...
func (v PutFleetsFleetIdMembersMemberIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson74e192f8EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PutFleetsFleetIdMembersMemberIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson74e192f8DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson74e192f8DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson74e192f8DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74e192f8EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PutFleetsFleetIdMembersMemberIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson74e192f8EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdMembersMemberIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson74e192f8DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson74e192f8DecodeGithubComContornoGoesiEsi1(l, v)
}
