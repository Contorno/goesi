...
func easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdFacilities200OkList) {
...
func easyjsonE4ed82a3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdFacilities200OkList) {
...
func (v GetCorporationsCorporationIdFacilities200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE4ed82a3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdFacilities200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFacilities200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdFacilities200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE4ed82a3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdFacilities200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FacilityId != 0 {
...
func (v GetCorporationsCorporationIdFacilities200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE4ed82a3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdFacilities200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdFacilities200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE4ed82a3DecodeGithubComContornoGoesiEsi1(l, v)
}
