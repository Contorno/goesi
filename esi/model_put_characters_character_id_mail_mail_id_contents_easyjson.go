...
func easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *PutCharactersCharacterIdMailMailIdContentsList) {
...
func easyjsonAd2c4d9fEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in PutCharactersCharacterIdMailMailIdContentsList) {
...
func (v PutCharactersCharacterIdMailMailIdContentsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAd2c4d9fEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *PutCharactersCharacterIdMailMailIdContentsList) UnmarshalJSON(data []byte) error {
	...
	easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutCharactersCharacterIdMailMailIdContentsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *PutCharactersCharacterIdMailMailIdContents) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAd2c4d9fEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in PutCharactersCharacterIdMailMailIdContents) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Labels) != 0 {
...
func (v PutCharactersCharacterIdMailMailIdContents) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAd2c4d9fEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutCharactersCharacterIdMailMailIdContents) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutCharactersCharacterIdMailMailIdContents) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAd2c4d9fDecodeGithubComContornoGoesiEsi1(l, v)
}
