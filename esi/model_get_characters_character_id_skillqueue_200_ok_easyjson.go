...
func easyjson2c8f07c0DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillqueue200OkList) {
...
func easyjson2c8f07c0EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdSkillqueue200OkList) {
...
func (v GetCharactersCharacterIdSkillqueue200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2c8f07c0EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdSkillqueue200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson2c8f07c0DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillqueue200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2c8f07c0DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson2c8f07c0DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillqueue200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2c8f07c0EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdSkillqueue200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCharactersCharacterIdSkillqueue200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2c8f07c0EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdSkillqueue200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2c8f07c0DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillqueue200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2c8f07c0DecodeGithubComContornoGoesiEsi1(l, v)
}
