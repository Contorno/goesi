...
func easyjson635b4880DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetWarsWarIdKillmails200OkList) {
...
func easyjson635b4880EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetWarsWarIdKillmails200OkList) {
...
func (v GetWarsWarIdKillmails200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson635b4880EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetWarsWarIdKillmails200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson635b4880DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdKillmails200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson635b4880DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson635b4880DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdKillmails200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson635b4880EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdKillmails200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.KillmailHash != "" {
...
func (v GetWarsWarIdKillmails200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson635b4880EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetWarsWarIdKillmails200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson635b4880DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdKillmails200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson635b4880DecodeGithubComContornoGoesiEsi1(l, v)
}
