...
func easyjson5f389623DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdContactsLabels200OkList) {
...
func easyjson5f389623EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdContactsLabels200OkList) {
...
func (v GetCharactersCharacterIdContactsLabels200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5f389623EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdContactsLabels200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5f389623DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContactsLabels200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5f389623DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5f389623DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdContactsLabels200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5f389623EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdContactsLabels200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LabelId != 0 {
...
func (v GetCharactersCharacterIdContactsLabels200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5f389623EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdContactsLabels200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5f389623DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdContactsLabels200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5f389623DecodeGithubComContornoGoesiEsi1(l, v)
}
