...
func easyjson5a3b9194DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdOkList) {
...
func easyjson5a3b9194EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdOkList) {
...
func (v GetDogmaDynamicItemsTypeIdItemIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a3b9194EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaDynamicItemsTypeIdItemIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5a3b9194DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a3b9194DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5a3b9194DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "dogma_effects":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson5a3b9194DecodeGithubComContornoGoesiEsi2(in, &v5)
...
func easyjson5a3b9194EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CreatedBy != 0 {
	...
	if len(in.DogmaEffects) != 0 {
		...
		}
		{
			...
			for v8, v9 := range in.DogmaEffects {
				...
				easyjson5a3b9194EncodeGithubComContornoGoesiEsi2(out, v9)
			}
			out.RawByte(']')
		}
	}
...
func (v GetDogmaDynamicItemsTypeIdItemIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a3b9194EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaDynamicItemsTypeIdItemIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5a3b9194DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaDynamicItemsTypeIdItemIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a3b9194DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson5a3b9194DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5a3b9194EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetDogmaDynamicItemsTypeIdItemIdDogmaEffect) {
	out.RawByte('{')
	first := true
	_ = first
	if in.EffectId != 0 {
