...
func easyjsonEcad90f3DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseRaces200OkList) {
...
func easyjsonEcad90f3EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseRaces200OkList) {
...
func (v GetUniverseRaces200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEcad90f3EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseRaces200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEcad90f3DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRaces200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEcad90f3DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonEcad90f3DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseRaces200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEcad90f3EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseRaces200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetUniverseRaces200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEcad90f3EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseRaces200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEcad90f3DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRaces200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEcad90f3DecodeGithubComContornoGoesiEsi1(l, v)
}
