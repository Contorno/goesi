...
func easyjsonBeee0876DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdStarbases200OkList) {
...
func easyjsonBeee0876EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdStarbases200OkList) {
...
func (v GetCorporationsCorporationIdStarbases200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBeee0876EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdStarbases200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonBeee0876DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStarbases200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBeee0876DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonBeee0876DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdStarbases200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBeee0876EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdStarbases200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MoonId != 0 {
...
func (v GetCorporationsCorporationIdStarbases200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBeee0876EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdStarbases200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonBeee0876DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStarbases200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBeee0876DecodeGithubComContornoGoesiEsi1(l, v)
}
