...
func easyjsonFb912c78DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdWalletsDivisionTransactions200OkList) {
...
func easyjsonFb912c78EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdWalletsDivisionTransactions200OkList) {
...
func (v GetCorporationsCorporationIdWalletsDivisionTransactions200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFb912c78EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdWalletsDivisionTransactions200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFb912c78DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdWalletsDivisionTransactions200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFb912c78DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFb912c78DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdWalletsDivisionTransactions200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFb912c78EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdWalletsDivisionTransactions200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ClientId != 0 {
...
func (v GetCorporationsCorporationIdWalletsDivisionTransactions200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFb912c78EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdWalletsDivisionTransactions200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFb912c78DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdWalletsDivisionTransactions200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFb912c78DecodeGithubComContornoGoesiEsi1(l, v)
}
