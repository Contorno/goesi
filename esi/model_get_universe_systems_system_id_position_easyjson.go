...
func easyjson48f41785DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPositionList) {
...
func easyjson48f41785EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseSystemsSystemIdPositionList) {
...
func (v GetUniverseSystemsSystemIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson48f41785EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseSystemsSystemIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson48f41785DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson48f41785DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson48f41785DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson48f41785EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseSystemsSystemIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseSystemsSystemIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson48f41785EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSystemsSystemIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson48f41785DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson48f41785DecodeGithubComContornoGoesiEsi1(l, v)
}
