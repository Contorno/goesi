...
func easyjsonC50fbf15DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItemsItemList) {
...
func easyjsonC50fbf15EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItemsItemList) {
...
func (v GetKillmailsKillmailIdKillmailHashItemsItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC50fbf15EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetKillmailsKillmailIdKillmailHashItemsItemList) UnmarshalJSON(data []byte) error {
	...
	easyjsonC50fbf15DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItemsItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC50fbf15DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonC50fbf15DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItemsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC50fbf15EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItemsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
...
func (v GetKillmailsKillmailIdKillmailHashItemsItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC50fbf15EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetKillmailsKillmailIdKillmailHashItemsItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC50fbf15DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItemsItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC50fbf15DecodeGithubComContornoGoesiEsi1(l, v)
}
