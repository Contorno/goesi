...
func easyjson77ba4aeDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) {
...
func easyjson77ba4aeEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson77ba4aeEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson77ba4aeDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson77ba4aeDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson77ba4aeDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson77ba4aeEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson77ba4aeEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson77ba4aeDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson77ba4aeDecodeGithubComContornoGoesiEsi1(l, v)
}
