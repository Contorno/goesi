...
func easyjson5822bb47DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetWarsWarIdAggressorList) {
...
func easyjson5822bb47EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetWarsWarIdAggressorList) {
...
func (v GetWarsWarIdAggressorList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5822bb47EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetWarsWarIdAggressorList) UnmarshalJSON(data []byte) error {
	...
	easyjson5822bb47DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdAggressorList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5822bb47DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5822bb47DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdAggressor) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5822bb47EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdAggressor) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetWarsWarIdAggressor) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5822bb47EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetWarsWarIdAggressor) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5822bb47DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetWarsWarIdAggressor) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5822bb47DecodeGithubComContornoGoesiEsi1(l, v)
}
