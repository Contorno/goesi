...
func easyjson682940b2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsVictoryPointsList) {
...
func easyjson682940b2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsVictoryPointsList) {
...
func (v GetFwLeaderboardsVictoryPointsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson682940b2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsVictoryPointsList) UnmarshalJSON(data []byte) error {
	...
	easyjson682940b2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsVictoryPointsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson682940b2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson682940b2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsVictoryPoints) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "active_total":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson682940b2DecodeGithubComContornoGoesiEsi2(in, &v4)
...
func easyjson682940b2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsVictoryPoints) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.ActiveTotal) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v7, v8 := range in.ActiveTotal {
				...
				easyjson682940b2EncodeGithubComContornoGoesiEsi2(out, v8)
			}
			out.RawByte(']')
		}
	}
...
func (v GetFwLeaderboardsVictoryPoints) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson682940b2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsVictoryPoints) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson682940b2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsVictoryPoints) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson682940b2DecodeGithubComContornoGoesiEsi1(l, v)
}
func easyjson682940b2DecodeGithubComContornoGoesiEsi2(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalActiveTotal1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson682940b2EncodeGithubComContornoGoesiEsi2(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalActiveTotal1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
