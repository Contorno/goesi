...
func easyjson46cd36d5DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeekLastWeek1List) {
...
func easyjson46cd36d5EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsLastWeekLastWeek1List) {
...
func (v GetFwLeaderboardsLastWeekLastWeek1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson46cd36d5EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsLastWeekLastWeek1List) UnmarshalJSON(data []byte) error {
	...
	easyjson46cd36d5DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeekLastWeek1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson46cd36d5DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson46cd36d5DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeekLastWeek1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson46cd36d5EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsLastWeekLastWeek1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsLastWeekLastWeek1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson46cd36d5EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsLastWeekLastWeek1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson46cd36d5DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeekLastWeek1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson46cd36d5DecodeGithubComContornoGoesiEsi1(l, v)
}
