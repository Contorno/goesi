...
func easyjsonFa8e3062DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsWalletWalletList) {
...
func easyjsonFa8e3062EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsWalletWalletList) {
...
func (v GetCorporationsCorporationIdDivisionsWalletWalletList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFa8e3062EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdDivisionsWalletWalletList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFa8e3062DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsWalletWalletList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFa8e3062DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjsonFa8e3062DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsWalletWallet) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFa8e3062EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsWalletWallet) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Division != 0 {
...
func (v GetCorporationsCorporationIdDivisionsWalletWallet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFa8e3062EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdDivisionsWalletWallet) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFa8e3062DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsWalletWallet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFa8e3062DecodeGithubComContornoGoesiEsi1(l, v)
}
