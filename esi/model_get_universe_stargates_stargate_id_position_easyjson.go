...
func easyjson7613fdDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdPositionList) {
...
func easyjson7613fdEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseStargatesStargateIdPositionList) {
...
func (v GetUniverseStargatesStargateIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7613fdEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseStargatesStargateIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson7613fdDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7613fdDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson7613fdDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7613fdEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseStargatesStargateIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseStargatesStargateIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7613fdEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStargatesStargateIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7613fdDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7613fdDecodeGithubComContornoGoesiEsi1(l, v)
}
