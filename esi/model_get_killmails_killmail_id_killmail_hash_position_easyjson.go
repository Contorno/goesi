...
func easyjson1251048eDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashPositionList) {
...
func easyjson1251048eEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashPositionList) {
...
func (v GetKillmailsKillmailIdKillmailHashPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1251048eEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetKillmailsKillmailIdKillmailHashPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson1251048eDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1251048eDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson1251048eDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1251048eEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetKillmailsKillmailIdKillmailHashPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1251048eEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetKillmailsKillmailIdKillmailHashPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1251048eDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1251048eDecodeGithubComContornoGoesiEsi1(l, v)
}
