...
func easyjson8f350f00DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdMining200OkList) {
...
func easyjson8f350f00EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdMining200OkList) {
...
func (v GetCharactersCharacterIdMining200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f350f00EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdMining200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8f350f00DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMining200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f350f00DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson8f350f00DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdMining200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8f350f00EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdMining200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Date != "" {
...
func (v GetCharactersCharacterIdMining200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f350f00EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMining200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8f350f00DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMining200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f350f00DecodeGithubComContornoGoesiEsi1(l, v)
}
