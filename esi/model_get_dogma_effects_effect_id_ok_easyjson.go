...
func easyjson315d323dDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdOkList) {
...
func easyjson315d323dEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetDogmaEffectsEffectIdOkList) {
...
func (v GetDogmaEffectsEffectIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson315d323dEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetDogmaEffectsEffectIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson315d323dDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson315d323dDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson315d323dDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson315d323dEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetDogmaEffectsEffectIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
...
func (v GetDogmaEffectsEffectIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson315d323dEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaEffectsEffectIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson315d323dDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson315d323dDecodeGithubComContornoGoesiEsi1(l, v)
}
