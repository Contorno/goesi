...
func easyjson5c16eda7DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetUniverseCategoriesCategoryIdOkList) {
...
func easyjson5c16eda7EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetUniverseCategoriesCategoryIdOkList) {
...
func (v GetUniverseCategoriesCategoryIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5c16eda7EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetUniverseCategoriesCategoryIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5c16eda7DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseCategoriesCategoryIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5c16eda7DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson5c16eda7DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetUniverseCategoriesCategoryIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5c16eda7EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetUniverseCategoriesCategoryIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CategoryId != 0 {
...
func (v GetUniverseCategoriesCategoryIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5c16eda7EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseCategoriesCategoryIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5c16eda7DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseCategoriesCategoryIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5c16eda7DecodeGithubComContornoGoesiEsi1(l, v)
}
