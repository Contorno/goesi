...
func easyjson92434c2dDecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsYesterdayYesterdayList) {
...
func easyjson92434c2dEncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsYesterdayYesterdayList) {
...
func (v GetFwLeaderboardsYesterdayYesterdayList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson92434c2dEncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsYesterdayYesterdayList) UnmarshalJSON(data []byte) error {
	...
	easyjson92434c2dDecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterdayYesterdayList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson92434c2dDecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson92434c2dDecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsYesterdayYesterday) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson92434c2dEncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsYesterdayYesterday) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsYesterdayYesterday) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson92434c2dEncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsYesterdayYesterday) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson92434c2dDecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterdayYesterday) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson92434c2dDecodeGithubComContornoGoesiEsi1(l, v)
}
