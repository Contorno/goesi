...
func easyjson8daaa5f2DecodeGithubComContornoGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeekLastWeek1List) {
...
func easyjson8daaa5f2EncodeGithubComContornoGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeekLastWeek1List) {
...
func (v GetFwLeaderboardsCharactersLastWeekLastWeek1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8daaa5f2EncodeGithubComContornoGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersLastWeekLastWeek1List) UnmarshalJSON(data []byte) error {
	...
	easyjson8daaa5f2DecodeGithubComContornoGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeekLastWeek1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8daaa5f2DecodeGithubComContornoGoesiEsi(l, v)
}
func easyjson8daaa5f2DecodeGithubComContornoGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeekLastWeek1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8daaa5f2EncodeGithubComContornoGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeekLastWeek1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersLastWeekLastWeek1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8daaa5f2EncodeGithubComContornoGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersLastWeekLastWeek1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8daaa5f2DecodeGithubComContornoGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeekLastWeek1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8daaa5f2DecodeGithubComContornoGoesiEsi1(l, v)
}
